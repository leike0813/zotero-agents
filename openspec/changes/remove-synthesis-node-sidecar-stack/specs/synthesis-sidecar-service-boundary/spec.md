...
cutover coordination, lifecycle supervision, and bounded Zotero/Host adapters,
and Rust MUST NOT gain direct access to Zotero DB, credentials, UI objects, or
