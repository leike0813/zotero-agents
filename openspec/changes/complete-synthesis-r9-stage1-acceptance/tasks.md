...
- [ ] 1.2 Map prebuild v4, verification v2, bundle manifests, XPI digest, compatibility receipts, and Run Manifests to one candidate; identify any missing evidence fields before adding a collector or validator
...
- [ ] 5.5 Repair stale discovery cleanup across previous session roots after a forced host-owner death; verify the lock winner clears it before readiness, a live lock loser leaves it intact, and the HB-03 real-machine case passes on rebuilt candidate bytes
