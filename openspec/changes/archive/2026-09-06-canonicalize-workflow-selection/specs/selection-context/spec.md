...
**Reason**: Exact basis-bound pages replace the snapshot, promotion and aggregate cap.
**Migration**: Consume getSelectedItems pages and lock the ordered refs only after complete acquisition.
