...
#### Scenario: Snapshot has registry and graph data

- **WHEN** the host sends a snapshot containing artifacts, registry rows, graph
  nodes, and graph edges
- **THEN** the web panel SHALL render navigable MVP views for those sections.
