...
- Admit `CG-02` for the Windows Zotero 10 Citation Graph close crash: establish a red-capable public-UI reproduction, diagnose and fix the root cause, retain the regression, and explicitly classify Zotero 9 from evidence.
...
- May change the production owner identified by the `CG-02` diagnosis, but does not authorize a speculative fix or a parallel runner.
