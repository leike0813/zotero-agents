...
- [ ] 12.5 Under separate execution authorization, replace the stale eight-capability bundles with one exact seven-platform content-addressed candidate and prove freshness, licenses, provenance, SBOM, per-target size, aggregate size, and native-only XPI inventory
