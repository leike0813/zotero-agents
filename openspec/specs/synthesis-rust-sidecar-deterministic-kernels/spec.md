# synthesis-rust-sidecar-deterministic-kernels Specification

## Purpose
Defines the Rust sidecar deterministic kernels capability for the Synthesis plugin, specifying its native compute ownership, paged transfer protocol, cross-language semantic guarantees, and resource gating.
