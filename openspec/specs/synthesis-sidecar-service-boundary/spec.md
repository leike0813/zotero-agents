...
## Purpose
Defines the synthesis sidecar service boundary capability for the Synthesis plugin, specifying its service boundary, integration contracts, and runtime behavior.
