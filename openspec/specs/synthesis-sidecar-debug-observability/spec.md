...
Defines the debug observability contract for the Synthesis sidecar: structured runtime-admission failure projection that does not depend on human-readable message tokenization.
