...
## Purpose
Defines the runtime foundation for the Synthesis sidecar durable-bundle-import component, including its service wiring, dependency injection, and integration with the sidecar process lifecycle.
