...
from an actual split-skill gate/runtime run using the minimal runtime contract.
...
- **THEN** SQLite state, handoffs, runtime views, sidecars,
  sections, and final candidate files SHALL be generated by runtime actions
