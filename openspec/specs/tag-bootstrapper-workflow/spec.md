# tag-bootstrapper-workflow Specification

## Purpose
Defines the built-in tag bootstrapper workflow that runs without item selection to bootstrap a Synthesis tag vocabulary from scratch.
