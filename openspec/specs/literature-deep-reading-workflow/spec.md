...
Specifies the `literature-deep-reading` workflow within the `literature-workbench-package`: source selection, source bundle construction, skill job submission, and result application for the deep-reading HTML artifact.
