...
## Purpose
Defines the application-level foundation for the Synthesis sidecar knowledge checkpoint component, including its service boundary, lifecycle, and integration with the sidecar runtime.
