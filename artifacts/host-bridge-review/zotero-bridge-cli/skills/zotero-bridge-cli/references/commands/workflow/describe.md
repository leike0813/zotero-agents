...
| Token | Id | Kind | Required | Conditional requirement | Values / arity | Repeatable | Environment | Conflicts | Help |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| --workflow | workflow | option | yes | — | WORKFLOW | no | — | — | 要描述的 Workflow id |
| --workflow-options | workflow_options | option | no | — | JSON_OR_FILE | no | — | — | 草拟的 workflow options JSON 对象、文件路径、@file 或 '-' 表示 stdin |
