...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/workflows/literature-explainer_note.webp" alt="Literature Explainer学習ノート" title="Literature Explainer学習ノート" loading="lazy" /><figcaption>Literature Explainer学習ノート</figcaption></figure>
...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — 文献ダイジェストを自動生成（先に実行することを推奨）
- [Deep Reading](#doc/workflows%2Fliterature-deep-reading) — 構造化された深読ビューを生成
