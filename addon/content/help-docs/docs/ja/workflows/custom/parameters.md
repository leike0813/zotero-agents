...
多言語化の完全な仕組みについては[多言語化](#doc/workflows%2Fcustom%2Flocalization)のページを参照。

## 次のステップ

- [選択コンテキスト](#doc/workflows%2Fcustom%2Fselection-context) — ユーザーのアイテム選択が Workflow にどのように渡されるかを理解する
- [リクエスト種別](#doc/workflows%2Fcustom%2Frequest-kinds) — 異なるリクエスト種別でのパラメータの受け渡し方法
