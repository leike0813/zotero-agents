...
<figure class="zs-doc-figure zs-doc-figure--icon"><img src="chrome://zotero-skills/content/help-docs/assets/img/icon_play.webp" alt="Run Workflowツールバーボタン" title="Run Workflowツールバーボタン" loading="lazy" /><figcaption>Run Workflowツールバーボタン</figcaption></figure>
