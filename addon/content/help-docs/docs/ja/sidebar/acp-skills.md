...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/sidebar/acp-skills.webp" alt="ACP Skillsパネル" title="ACP Skillsパネル" loading="lazy" /><figcaption>ACP Skillsパネル</figcaption></figure>
...
ACP Skillsパネルを使用するには、あらかじめ[ACPバックエンド](#doc/backends%2Facp)を設定する必要があります。
