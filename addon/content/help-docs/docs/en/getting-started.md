...
→ See [ACP Backend Configuration](#doc/backends%2Facp) for details
...
→ See [MinerU Usage Guide](#doc/workflows%2Fmineru) for details

### Alternative: Docker-deployed Skill-Runner

If you need persistent background execution or LAN sharing, you can [deploy Skill-Runner with Docker](#doc/backends%2Fskill-runner#recommended-docker-persistent-deployment). After deployment, add a backend instance in the SkillRunner tab.

> For detailed operation instructions, see [Backend Manager](#doc/backends%2Fbackend-manager).
...
→ See [Built-in Markdown Reader](#doc/markdown-reader) for details
...
→ See [Literature Analysis](#doc/workflows%2Fliterature-analysis) for details
...
→ See [Literature Explainer](#doc/workflows%2Fliterature-explainer) for details
...
→ See [Deep Reading](#doc/workflows%2Fliterature-deep-reading) for details
...
→ See [Topic Synthesis](#doc/workflows%2Ftopic-synthesis) for details

## Next Steps

- **Batch Processing**: Run [Literature Analysis](#doc/workflows%2Fliterature-analysis) on papers in your library in bulk to build the foundation for Synthesis
- **Tag System**: Use [Tag Bootstrapper](#doc/workflows%2Ftag-bootstrapper) to create a controlled vocabulary and standardize your metadata
- **Graph Exploration**: Visualize your citation network in the [Synthesis Workbench](#doc/synthesis%2Findex)
- **Custom Development**: Refer to [Custom Workflows](#doc/workflows%2Fcustom%2Findex) to create your own workflows
