...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/markdown-reader.webp" alt="Built-in Markdown Reader Page" title="Built-in Markdown Reader Page" loading="lazy" /><figcaption>Built-in Markdown Reader Page</figcaption></figure>
