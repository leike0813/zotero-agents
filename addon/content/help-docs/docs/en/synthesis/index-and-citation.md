...
In the [Review Hub](#doc/synthesis%2Freview), you can view and process citation match proposals, accepting or rejecting them one by one.
...
- [Review Hub](#doc/synthesis%2Freview) — Review citation match and deduplication proposals
- [Create Topic Synthesis](#doc/synthesis%2Ftopic-synthesis) — Create topic analyses based on citation networks
- [Home Dashboard](#doc/synthesis%2Fhome) — View library insight metrics
- [WebDAV Sync](#doc/synthesis%2Fwebdav-sync) — Sync citation binding data across devices
