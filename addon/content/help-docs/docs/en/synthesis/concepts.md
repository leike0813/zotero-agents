...
Change proposals to the concept knowledge base (new concepts, new senses, new relationships) appear in the Concepts review tab of the [Review Hub](#doc/synthesis%2Freview). You can review and decide whether to accept these proposals.
...
- [Review Hub](#doc/synthesis%2Freview) — Review concept suggestions
- [Tags Management](#doc/synthesis%2Ftags) — Manage the controlled tag vocabulary
- [Topic Synthesis](#doc/synthesis%2Ftopic-synthesis) — Leverage concept knowledge when creating topic syntheses
