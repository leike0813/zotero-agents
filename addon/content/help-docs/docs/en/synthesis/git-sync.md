...
**Please use [WebDAV Sync](#doc/synthesis%2Fwebdav-sync) instead.**
...
- [Home Dashboard](#doc/synthesis%2Fhome) — View the sync status panel
- [Tags Management](#doc/synthesis%2Ftags) — Manage the controlled tag vocabulary
- [Preferences](#doc/preferences) — Configure Git repository parameters
