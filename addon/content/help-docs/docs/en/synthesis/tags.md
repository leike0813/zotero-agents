...
Tag standardization and automatic inference are driven by the [Tag Regulator](#doc/workflows%2Ftag-regulator) workflow. Running this workflow can automatically clean up and supplement tags based on the controlled vocabulary.
