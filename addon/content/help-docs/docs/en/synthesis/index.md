...
|---------|----------|------|
| **Home** | Library overview dashboard: library insights, WebDAV sync status, and trending topic cards | [Details](#doc/synthesis%2Fhome) |
...
- [WebDAV Sync](#doc/synthesis%2Fwebdav-sync) — Configure durable data sync
