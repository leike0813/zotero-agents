...
Interactively create a controlled tag vocabulary for a research domain with AI. Recommended to run before your first [Literature Analysis](#doc/workflows%2Fliterature-analysis) to establish a foundation for subsequent automatic tag regulation.
...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Can automatically cascade tag regulation during analysis
- [Tag Regulator](#doc/workflows%2Ftag-regulator) — Run tag regulation on existing literature
