...
Notes generated by [Literature Analysis](#doc/workflows%2Fliterature-analysis) are **rendered** from backend data; directly modifying the note content will not change the backend data. If you need to edit analysis results, the correct approach is: **Export Notes** → modify the exported files → use **Import Notes** to re-import.
:::
...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Generate the three types of exportable notes
