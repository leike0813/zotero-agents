...
2. Run [Literature Analysis](#doc/workflows%2Fliterature-analysis) + [Tag Regulator](#doc/workflows%2Ftag-regulator) on all papers
3. Run Advance Matching in the Synthesis Workbench and handle approval items
4. Create several related [Topic Syntheses](#doc/workflows%2Ftopic-synthesis)
:::
...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Establish a structured knowledge foundation for papers
- [Topic Synthesis](#doc/workflows%2Ftopic-synthesis) — Create topic syntheses first, then write the paper based on analysis results
