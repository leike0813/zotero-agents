...
Translate a literature attachment (Markdown or PDF) into a specified target language, producing a translated Markdown file and bilingual alignment data. It is strongly recommended to convert PDFs to Markdown first using [MinerU](#doc/workflows%2Fmineru) for significantly better translation quality.
...
- [MinerU PDF Parsing](#doc/workflows%2Fmineru) — Convert PDF to Markdown first for better translation quality
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Generate literature digest and analysis artifacts
