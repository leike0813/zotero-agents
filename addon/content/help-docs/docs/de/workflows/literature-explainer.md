...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/workflows/literature-explainer_note.webp" alt="Literature Explainer Lernnotiz" title="Literature Explainer Lernnotiz" loading="lazy" /><figcaption>Literature Explainer Lernnotiz</figcaption></figure>
...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Automatisch Literatur-Zusammenfassungen erstellen (empfohlen, zuerst auszuführen)
- [Deep Reading](#doc/workflows%2Fliterature-deep-reading) — Eine strukturierte Deep-Reading-Ansicht erstellen
