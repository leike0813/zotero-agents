...
Einen Literatur-Anhang (Markdown oder PDF) in eine angegebene Zielsprache übersetzen und eine übersetzte Markdown-Datei sowie zweisprachige Ausrichtungsdaten erzeugen. Es wird dringend empfohlen, PDFs zuerst mit [MinerU](#doc/workflows%2Fmineru) in Markdown zu konvertieren, um die Übersetzungsqualität erheblich zu verbessern.
...
- [MinerU PDF Parsing](#doc/workflows%2Fmineru) — PDF zuerst in Markdown konvertieren für bessere Übersetzungsqualität
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Literaturdigest und Analyseartefakte generieren
