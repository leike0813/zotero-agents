...
1. Öffnen Sie **Tools → [Backend Manager](#doc/backends%2Fbackend-manager)**
...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Zusammenfassungen und Zitationsanalysen aus dem geparsten Markdown erstellen
