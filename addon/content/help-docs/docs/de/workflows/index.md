...
| **Export/Import Literature Bundle** | Portable ZIP-Bundles von Zotero-Einträgen mit Metadaten, Anhängen und Notizen exportieren/importieren | Übergeordneter Eintrag / Workflow | Pass-through | [Details](#doc/workflows%2Fexport-import-literature-bundle) |
...
| **Tag Auditor** | Alle Bibliothekseinträge gegen das kontrollierte Tag-Vokabular scannen und Konformität melden | Workflow | Pass-through | [Details](#doc/workflows%2Ftag-auditor) |
...
| **Export/Import Notes** | Analyse-Notizen exportieren oder importieren, mit Unterstützung für Bearbeitung und Reimport | Übergeordneter Eintrag | Pass-through | [Details](#doc/workflows%2Fexport-import-notes) |
