...
- **Kontrolliertes Vokabular**: Ein kontrolliertes Tag-Vokabular muss zuerst definiert werden; siehe [Tags-Verwaltung](#doc/synthesis%2Ftags)

## Verwandte Workflows

- [Tag Regulator](#doc/workflows%2Ftag-regulator) — Tags basierend auf dem kontrollierten Vokabular normalisieren und neue Tags inferieren
- [Tag Bootstrapper](#doc/workflows%2Ftag-bootstrapper) — Interaktiv ein kontrolliertes Tag-Vokabular erstellen
