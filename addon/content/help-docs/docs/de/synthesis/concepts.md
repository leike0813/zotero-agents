...
Änderungsvorschläge an der Konzept-Wissensbasis (neue Konzepte, neue Sinnvarianten, neue Beziehungen) erscheinen im Konzepte-Review-Tab des [Review-Hubs](#doc/synthesis%2Freview). Sie können diese Vorschläge prüfen und entscheiden, ob Sie sie akzeptieren möchten.
...
- [Review-Zentrale](#doc/synthesis%2Freview) – Konzeptvorschläge prüfen
- [Tag-Verwaltung](#doc/synthesis%2Ftags) – Das kontrollierte Tag-Vokabular verwalten
- [Themensynthese](#doc/synthesis%2Ftopic-synthesis) – Konzeptwissen beim Erstellen von Themensynthesen nutzen
