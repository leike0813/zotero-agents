...
|------------|----------|------|
| **Home** | Bibliotheksübersicht mit Einblicken, WebDAV-Sync-Status und Trendthemen | [Details](#doc/synthesis%2Fhome) |
...
- [WebDAV Sync](#doc/synthesis%2Fwebdav-sync) – Dauerhafte Datensynchronisierung konfigurieren
