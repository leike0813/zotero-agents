...
2. Öffnen Sie **Werkzeuge → [Backend-Manager](#doc/backends%2Fbackend-manager)**
...
- Sitzungen können im [ACP-Chat](#doc/sidebar%2Facp-chat) verwaltet werden

## Nächste Schritte

Nach Abschluss der Konfiguration können Sie:
- Im [Seitenleisten-ACP-Chat](#doc/sidebar%2Facp-chat) mit dem Backend chatten
- ACP-Skill-Ausführungen im [Dashboard](#doc/dashboard) anzeigen
- Das ACP-Backend zur Ausführung von Aufgaben in der [Workflow-Liste](#doc/workflows%2Findex) verwenden
