...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/sidebar/skillrunner-tab.webp" alt="SkillRunner-Panel" title="SkillRunner-Panel" loading="lazy" /><figcaption>SkillRunner-Panel</figcaption></figure>
...
Vor der Nutzung des SkillRunner-Tabs muss ein [Skill-Runner-Backend](#doc/backends%2Fskill-runner) konfiguriert werden.
