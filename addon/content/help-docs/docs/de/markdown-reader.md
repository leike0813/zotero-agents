...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/markdown-reader.webp" alt="Seite des integrierten Markdown-Readers" title="Seite des integrierten Markdown-Readers" loading="lazy" /><figcaption>Seite des integrierten Markdown-Readers</figcaption></figure>
