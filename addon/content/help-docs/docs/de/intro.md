...
> **Unterstützte Zotero-Versionen**: Dieses Plugin unterstützt Zotero 7, 9 und 10. Unter Windows und Linux werden die repräsentativen Versionen 7.0.32, 9.0.6 und 10.0.1 getestet. Für Zotero 10 unter macOS liegt derzeit ein nicht blockierender formaler XPI-Smoke-Test vor; dies ist keine Aussage über alle früheren Patch-Versionen.

:::tip Tipp
Das Plugin wird **ohne integrierte Geschäftslogik** ausgeliefert. Alle Workflows werden über separate **offizielle Workflow-Pakete** bereitgestellt, die Benutzer nach der Installation des Plugins herunterladen und installieren müssen. Details finden Sie im [Installationsleitfaden](#doc/installation).
:::
...
- [Installationsleitfaden](#doc/installation) — Installation des Plugins und seiner Abhängigkeiten
- [Erste Schritte](#doc/getting-started) — Konfigurieren Sie Ihr erstes Backend und führen Sie einen Skill aus
- [Backend-Konfiguration](#doc/backends%2Findex) — Lernen Sie die drei unterstützten Backend-Typen kennen

## Dokumentation

| Abschnitt | Beschreibung |
|-----------|-------------|
| [Installationsleitfaden](#doc/installation) | Plugin-Installation, Installation offizieller Workflow-Pakete, Skill-Runner-Backend-Bereitstellung |
| [Integrierter Markdown-Reader](#doc/markdown-reader) | Doppelklick auf `.md`-Dateien zum Öffnen in Zotero, mit Gliederung, Suche und Mathematik-Rendering |
| [Backend-Konfiguration](#doc/backends%2Findex) | Konfigurationsleitfaden für ACP-, Skill-Runner- und Generic-HTTP-Backends |
| [Workflow](#doc/workflows%2Findex) | Workflow-Einführung und Aufrufleitfaden |
| [Dashboard](#doc/dashboard) | Leitfaden zur Nutzung des zentralen Überwachungspanels |
| [Seitenleiste & ACP-Chat](#doc/sidebar%2Findex) | Seitenleisten-Panel und Konversationsfunktionen |
| [Synthesis Workbench](#doc/synthesis%2Findex) | Leitfaden zur Nutzung des Synthesis Workbench |
| [Einstellungen](#doc/preferences) | Plugin-Einstellungsreferenz |
