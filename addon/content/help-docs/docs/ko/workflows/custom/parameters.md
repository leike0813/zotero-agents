...
전체 지역화 메커니즘에 대해서는 [지역화](#doc/workflows%2Fcustom%2Flocalization) 페이지를 참조하세요.

## 다음 단계

- [선택 컨텍스트](#doc/workflows%2Fcustom%2Fselection-context) — 사용자의 항목 선택이 Workflow에 전달되는 방식 이해
- [요청 종류](#doc/workflows%2Fcustom%2Frequest-kinds) — 다양한 요청 종류에 대한 파라미터 전달 방법
