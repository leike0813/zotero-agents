...
AI와 함께 연구 도메인에 대한 제어된 태그 어휘를 대화형으로 생성합니다. 첫 [Literature Analysis](#doc/workflows%2Fliterature-analysis) 전에 실행하여 이후 자동 태그 규정의 기반을 마련하는 것이 좋습니다.
...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — 분석 중 자동 태그 규제를 연속 실행할 수 있습니다
- [Tag Regulator](#doc/workflows%2Ftag-regulator) — 기존 문헌에 태그 규제를 실행합니다
