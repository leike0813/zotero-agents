...
> **지원 Zotero 버전**: 이 플러그인은 Zotero 7, 9, 10을 지원합니다. Windows와 Linux에서는 대표 버전인 7.0.32, 9.0.6, 10.0.1을 테스트합니다. macOS의 Zotero 10은 현재 비차단 정식 XPI 스모크 테스트만 증거로 사용하며, 모든 이전 패치 버전을 포괄한다는 뜻은 아닙니다.
