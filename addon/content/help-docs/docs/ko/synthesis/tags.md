...
이를 생성하기 위해 Tag Bootstrapper를 실행할 필요가 없습니다. Tag Bootstrapper는 사용자 정의 어휘 항목만 추가하며, [Tag Regulator](#doc/workflows%2Ftag-regulator)는 일반 제어 태그를 감사할 수 있지만 문헌 항목에 내장 Workflow 상태를 추가하거나 제거할 수 없습니다. 두 Workflow 모두 논문의 주제, 언어, 메타데이터 또는 전문에서 내장 상태를 추론할 수 없습니다.
