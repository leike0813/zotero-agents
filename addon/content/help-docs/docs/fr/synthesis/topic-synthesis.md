...
- [Backend Skill-Runner](#doc/backends%2Fskill-runner) configuré
...
Ce pipeline est orchestré par le workflow [Création de synthèse de sujet](#doc/workflows%2Ftopic-synthesis).
...
- [Création de synthèse de sujet](#doc/workflows%2Ftopic-synthesis) — Détails du workflow de création de sujets
- [Encadrement de la littérature pour manuscrit](#doc/workflows%2Fmanuscript-literature-framing) — Rédiger des articles basés sur l'analyse de sujets
