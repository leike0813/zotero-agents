...
Dans le [Centre de révision](#doc/synthesis%2Freview), vous pouvez voir et traiter les propositions de correspondance de citations, en les acceptant ou en les rejetant une par une.
...
- [Centre de révision](#doc/synthesis%2Freview) — Réviser les propositions de correspondance et de dédoublonnage de citations
- [Créer une synthèse de sujet](#doc/synthesis%2Ftopic-synthesis) — Créer des analyses de sujets basées sur les réseaux de citations
- [Tableau de bord Home](#doc/synthesis%2Fhome) — Voir les métriques d'aperçu de la bibliothèque
- [Synchronisation WebDAV](#doc/synthesis%2Fwebdav-sync) — Synchroniser les données de liaison de citations entre appareils
