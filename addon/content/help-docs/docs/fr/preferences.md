...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/preferences_workflow.webp" alt="Page des paramètres des workflows" title="Page des paramètres des workflows" loading="lazy" /><figcaption>Page des paramètres des workflows</figcaption></figure>
...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/preferences_official-workflow-contents.webp" alt="Contenu des packages de workflows officiels" title="Contenu des packages de workflows officiels" loading="lazy" /><figcaption>Contenu des packages de workflows officiels</figcaption></figure>
...
Un service HTTP intégré pour l'accès des outils IA externes et du CLI à la bibliothèque Zotero. Voir [Host Bridge](#doc/backends%2Fhost-bridge) pour plus de détails.
...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/preferences_host-bridge.webp" alt="Page des paramètres Host Bridge" title="Page des paramètres Host Bridge" loading="lazy" /><figcaption>Page des paramètres Host Bridge</figcaption></figure>
...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/preferences_host-bridge_expand.webp" alt="Zone des actions dangereuses Host Bridge dépliée" title="Zone des actions dangereuses Host Bridge dépliée" loading="lazy" /><figcaption>Zone des actions dangereuses Host Bridge dépliée</figcaption></figure>

## Backend local SkillRunner

> ⚠️ Ce mode convient uniquement aux utilisateurs qui ne connaissent rien à l'installation d'outils d'agents et ne peuvent pas utiliser Docker. Si vous avez déjà un agent ACP ou pouvez utiliser Docker, préférez le [backend ACP](#doc/backends%2Facp) ou le [Skill-Runner déployé avec Docker](#doc/backends%2Fskill-runner#recommended-docker-persistent-deployment).
...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/preferences_skillrunner-local-backend.webp" alt="Page des paramètres du backend local SkillRunner" title="Page des paramètres du backend local SkillRunner" loading="lazy" /><figcaption>Page des paramètres du backend local SkillRunner</figcaption></figure>
...
Solution de synchronisation multi-appareils pour le Synthesis Workbench, remplaçant Git Sync qui est obsolète. Voir [Synchronisation WebDAV](#doc/synthesis%2Fwebdav-sync) pour plus de détails.
...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/preferences_WebDAV-sync.webp" alt="Page des paramètres de synchronisation WebDAV" title="Page des paramètres de synchronisation WebDAV" loading="lazy" /><figcaption>Page des paramètres de synchronisation WebDAV</figcaption></figure>
...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/preferences_storage-and-persistence.webp" alt="Page de gestion des données d&#39;exécution et de la persistance" title="Page de gestion des données d&#39;exécution et de la persistance" loading="lazy" /><figcaption>Page de gestion des données d&#39;exécution et de la persistance</figcaption></figure>
