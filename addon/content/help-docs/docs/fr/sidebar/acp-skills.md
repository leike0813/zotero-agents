...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/sidebar/acp-skills.webp" alt="Panneau ACP Skills" title="Panneau ACP Skills" loading="lazy" /><figcaption>Panneau ACP Skills</figcaption></figure>
...
Le panneau ACP Skills nécessite qu'un [backend ACP](#doc/backends%2Facp) soit configuré avant utilisation.
