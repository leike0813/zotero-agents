...
- **Vocabulaire Contrôlé** : Un vocabulaire contrôlé doit être créé au préalable ; voir [Gestion des Balises](#doc/synthesis%2Ftags)
...
- [Gestion des Balises](#doc/synthesis%2Ftags) — Gérer le vocabulaire de balises contrôlé
