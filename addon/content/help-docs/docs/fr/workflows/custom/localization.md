...
- [Types de requêtes](#doc/workflows%2Fcustom%2Frequest-kinds) — Choisir le backend d'exécution et le type de requête
- [Empaquetage et déploiement](#doc/workflows%2Fcustom%2Fpackaging) — Publier des packages de workflows avec localisation
