...
Voir la page [Localisation](#doc/workflows%2Fcustom%2Flocalization) pour le mécanisme complet de localisation.

## Prochaines étapes

- [Contexte de sélection](#doc/workflows%2Fcustom%2Fselection-context) — Comprendre comment la sélection d'éléments de l'utilisateur est transmise au workflow
- [Types de requêtes](#doc/workflows%2Fcustom%2Frequest-kinds) — Méthodes de passage de paramètres pour les différents types de requêtes
