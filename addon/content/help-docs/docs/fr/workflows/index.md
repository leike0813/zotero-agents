...
| **Export/Import Literature Bundle** | Exporter/importer des bundles ZIP portables de notices Zotero avec métadonnées, pièces jointes et notes | Notice parente / workflow | Pass-through | [Détails](#doc/workflows%2Fexport-import-literature-bundle) |
...
| **Tag Auditor** | Analyser toutes les notices de la bibliothèque par rapport au vocabulaire de balises contrôlé et signaler la conformité | workflow | Pass-through | [Détails](#doc/workflows%2Ftag-auditor) |
...
| **Export/Import Notes** | Exporter ou importer des notes d'analyse avec prise en charge de l'édition et de la réimportation | Notice parente | Pass-through | [Détails](#doc/workflows%2Fexport-import-notes) |
