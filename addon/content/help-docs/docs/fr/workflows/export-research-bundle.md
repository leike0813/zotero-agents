...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Générer des artefacts de résumé et d'analyse de citation pouvant être inclus dans le bundle
- [Literature Search & Ingest](#doc/workflows%2Fliterature-search-ingest) — Rechercher et importer la littérature manquante avant d'assembler le bundle
- [Export/Import Literature Bundle](#doc/workflows%2Fexport-import-literature-bundle) — Exporter des bundles ZIP portables de notices Zotero (objectif différent)
