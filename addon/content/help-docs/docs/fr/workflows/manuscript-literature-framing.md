...
2. Exécuter [Literature Analysis](#doc/workflows%2Fliterature-analysis) + [Tag Regulator](#doc/workflows%2Ftag-regulator) sur tous les articles
3. Exécuter Advance Matching dans le Synthesis Workbench et traiter les éléments d'approbation
4. Créer plusieurs [Topic Syntheses](#doc/workflows%2Ftopic-synthesis) connexes
:::
...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Établir une base de connaissances structurée pour les articles
- [Topic Synthesis](#doc/workflows%2Ftopic-synthesis) — Créer d'abord des synthèses de sujet, puis rédiger l'article basé sur les résultats d'analyse
