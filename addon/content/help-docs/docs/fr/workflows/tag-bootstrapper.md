...
Créer interactivement un vocabulaire de balises contrôlé pour un domaine de recherche avec l'IA. Recommandé d'exécuter avant votre première [Literature Analysis](#doc/workflows%2Fliterature-analysis) pour établir une base pour la régulation automatique ultérieure des balises.
...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Peut enchaîner automatiquement la régulation de balises pendant l'analyse
- [Tag Regulator](#doc/workflows%2Ftag-regulator) — Exécuter la régulation de balises sur la littérature existante
