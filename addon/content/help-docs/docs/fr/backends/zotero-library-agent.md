...
3. Configurer le profil de connexion avec l'URL du point de terminaison et le jeton Bearer. Voir [Configuration du Host Bridge](#doc/backends%2Fhost-bridge) pour la configuration détaillée.

## Prochaines étapes

- [Host Bridge](#doc/backends%2Fhost-bridge) — référence complète de la CLI `zotero-bridge` et des capacités du Host Bridge
- [Hermes Profiles](#doc/backends%2Fhermes-profiles) — service de bibliothèque résident avec indexation locale et maintenance planifiée
- [Workflows](#doc/workflows%2Findex) — aperçu de tous les workflows intégrés et personnalisés
- [MCP Server](#doc/backends%2Fmcp-server) — interface de protocole alternative pour les clients compatibles MCP
