...
<figure class="zs-doc-figure zs-doc-figure--icon"><img src="chrome://zotero-skills/content/help-docs/assets/img/icon_play.webp" alt="执行 Workflow 工具栏按钮" title="执行 Workflow 工具栏按钮" loading="lazy" /><figcaption>执行 Workflow 工具栏按钮</figcaption></figure>
