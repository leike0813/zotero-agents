...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/workflows/literature-explainer_note.webp" alt="文献解释器学习笔记" title="文献解释器学习笔记" loading="lazy" /><figcaption>文献解释器学习笔记</figcaption></figure>
...
- [文献分析](#doc/workflows%2Fliterature-analysis) — 自动生成文献摘要（建议先执行）
- [深度阅读](#doc/workflows%2Fliterature-deep-reading) — 生成结构化精读视图
