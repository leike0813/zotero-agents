...
完整的本地化机制参见[本地化](#doc/workflows%2Fcustom%2Flocalization)页面。

## 下一步

- [选择上下文](#doc/workflows%2Fcustom%2Fselection-context) — 理解用户的条目选择是如何传递给 workflow 的
- [请求种类](#doc/workflows%2Fcustom%2Frequest-kinds) — 不同请求种类的参数传递方式
