...
与 AI 交互式创建研究领域的受控标签词表。建议在首次执行[文献分析](#doc/workflows%2Fliterature-analysis)之前运行，为后续的自动标签规范化建立基础。
...
- [文献分析](#doc/workflows%2Fliterature-analysis) — 分析时可自动级联执行标签规范化
- [标签规范化](#doc/workflows%2Ftag-regulator) — 对已有文献执行标签规整
