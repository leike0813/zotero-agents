...
1. 收集并入库足够的相关文献
2. 对所有文献执行 [文献分析](#doc/workflows%2Fliterature-analysis) + [标签规范化](#doc/workflows%2Ftag-regulator)
3. 在 Synthesis Workbench 中执行 Advance Matching 并处理审批项
4. 创建几个相关的 [Topic 综合](#doc/workflows%2Ftopic-synthesis)
:::
...
- [文献分析](#doc/workflows%2Fliterature-analysis) — 为文献建立结构化知识基础
- [Topic 综合创建](#doc/workflows%2Ftopic-synthesis) — 先创建主题综合，再基于分析结果撰写论文
