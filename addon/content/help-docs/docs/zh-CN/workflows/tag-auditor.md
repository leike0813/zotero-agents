...
- 无需后端连接
- **受控词表**：必须先定义受控标签词表；参见[标签管理](#doc/synthesis%2Ftags)

## 相关 Workflow

- [Tag Regulator](#doc/workflows%2Ftag-regulator) — 基于受控词表规范化标签并推断新标签
- [Tag Bootstrapper](#doc/workflows%2Ftag-bootstrapper) — 交互式创建受控标签词表
