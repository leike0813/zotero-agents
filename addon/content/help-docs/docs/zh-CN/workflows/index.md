...
| **文献元数据整理** | 查询、修正并补全 Zotero 条目的书目元数据 | 父条目 | Skill-Runner | [详情](#doc/workflows%2Fliterature-metadata-curator) |
| **文献翻译** | 带术语管理和质量门禁的学术文献翻译 | 附件 | Skill-Runner | [详情](#doc/workflows%2Fliterature-translator) |
...
| **导出/导入文献包** | 导出/导入含元数据、附件和笔记的 Zotero 条目便携式 ZIP 包 | 父条目 / workflow | Pass-through | [详情](#doc/workflows%2Fexport-import-literature-bundle) |
| **导出研究包** | 从现有库和 Synthesis 上下文自动组装论文项目的只读研究包 | workflow | Skill-Runner | [详情](#doc/workflows%2Fexport-research-bundle) |
| **标签审计** | 扫描库中所有条目的受控标签词表合规性并报告 | workflow | Pass-through | [详情](#doc/workflows%2Ftag-auditor) |
...
| **导出/导入笔记** | 导出或导入分析笔记，支持编辑后重新导入 | 父条目 | Pass-through | [详情](#doc/workflows%2Fexport-import-notes) |
