...
- 可在 [ACP Chat](#doc/sidebar%2Facp-chat) 中管理会话

## 下一步

配置完成后，您可以：
- 在 [侧边栏 ACP Chat](#doc/sidebar%2Facp-chat) 中与后端对话
- 在 [Dashboard](#doc/dashboard) 中查看 ACP skill run
- 在 [Workflow 列表](#doc/workflows%2Findex) 中使用 ACP 后端执行任务
