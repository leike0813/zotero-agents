...
- **Zotero**：7.0 或更高版本（推荐 Zotero 10）
- **平台**：Windows 10+、macOS 12+、Linux（x86_64 / x86 / ARM64 / ARM）

> **关于 Zotero 版本**：本插件支持 Zotero 7、9 和 10。
...
1. 点击 Zotero 工具栏中的 <figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/zotero-addons_icon.webp" alt="" title="" loading="lazy" /></figure> 图标打开插件市场
2. 搜索 **Zotero Agents**
3. 点击安装即可
