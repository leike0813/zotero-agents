...
<figure class="zs-doc-figure zs-doc-figure--poster"><img src="chrome://zotero-skills/content/help-docs/assets/img/poster.webp" alt="Zotero Agents 研究工作台海报" title="Zotero Agents 研究工作台海报" loading="lazy" /><figcaption>Zotero Agents 研究工作台海报</figcaption></figure>
...
> **支持的 Zotero 版本**：本插件支持 Zotero 7、9 和 10。

:::tip 提示
插件安装后**不含任何业务逻辑**。所有 Workflow 均通过独立的**官方 Workflow 包**提供，需要用户在安装插件后手动下载安装。详见[安装指南](#doc/installation)。
:::
...
- [安装指南](#doc/installation) — 安装插件及其依赖
- [快速开始](#doc/getting-started) — 配置第一个后端并运行技能
- [后端配置](#doc/backends%2Findex) — 了解支持的三种后端类型

## 文档目录

| 章节 | 说明 |
|------|------|
| [安装指南](#doc/installation) | 插件安装、官方 Workflow 包安装、Skill-Runner 后端部署 |
| [内置 Markdown 阅读器](#doc/markdown-reader) | 双击 `.md` 文件在 Zotero 内打开，支持大纲、搜索、公式渲染 |
| [后端配置](#doc/backends%2Findex) | ACP、Skill-Runner、Generic HTTP 后端的配置说明 |
| [Workflow](#doc/workflows%2Findex) | Workflow 介绍与调用指南 |
| [Dashboard](#doc/dashboard) | 中央监控面板使用说明 |
| [侧边栏与 ACP Chat](#doc/sidebar%2Findex) | 侧边栏面板和对话功能 |
| [Synthesis Workbench](#doc/synthesis%2Findex) | 综合工作台使用指南 |
| [偏好设置](#doc/preferences) | 插件设置项说明 |
