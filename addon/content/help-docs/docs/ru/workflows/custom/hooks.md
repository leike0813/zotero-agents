...
- [Контекст выделения](#doc/workflows%2Fcustom%2Fselection-context) — Подробная структура selectionContext
- [Справочник API хоста](#doc/workflows%2Fcustom%2Fhost-api) — Полный справочник API
- [Упаковка и развёртывание](#doc/workflows%2Fcustom%2Fpackaging) — Как упаковывать и развёртывать workflow
