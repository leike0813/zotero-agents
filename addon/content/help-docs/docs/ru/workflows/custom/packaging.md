...
- [Локализация](#doc/workflows%2Fcustom%2Flocalization) — Добавьте поддержку нескольких языков в Workflow
- [Request Kinds](#doc/workflows%2Fcustom%2Frequest-kinds) — Выберите соответствующий бэкенд выполнения и тип запроса
- [Отладка и тестирование](#doc/workflows%2Fcustom%2Fdebugging) — Проверьте правильность Workflow
