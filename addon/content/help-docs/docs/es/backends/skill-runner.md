...
> ⚠️ Este modo solo es adecuado para usuarios que **no saben cómo instalar herramientas de agente y no pueden usar Docker**. Si tienes capacidad para instalar CLIs de agente o usar Docker, por favor prefiere el [backend ACP](#doc/backends%2Facp) o el despliegue con Docker descrito arriba.
...
1. Abre **Herramientas → [Backend Manager](#doc/backends%2Fbackend-manager)**
...
- [Conocer los Workflows](#doc/workflows%2Findex) — Skill-Runner es uno de los principales backends para ejecutar workflows
- [Introducción al Dashboard](#doc/dashboard) — Supervisar el estado de ejecución de tareas
- [Pestaña SkillRunner](#doc/sidebar%2Fskillrunner-tab) — Ver e interactuar con ejecuciones de SkillRunner en la barra lateral
