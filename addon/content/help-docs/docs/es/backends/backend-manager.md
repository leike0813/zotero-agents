...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/backends/backend-manager_ACP.webp" alt="Página de configuración del backend ACP" title="Página de configuración del backend ACP" loading="lazy" /><figcaption>Página de configuración del backend ACP</figcaption></figure>
...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/backends/backend-manager_skillrunner.webp" alt="Página de configuración del backend SkillRunner" title="Página de configuración del backend SkillRunner" loading="lazy" /><figcaption>Página de configuración del backend SkillRunner</figcaption></figure>
...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/backends/backend-manager_generic-HTTP.webp" alt="Página de configuración del backend HTTP genérico" title="Página de configuración del backend HTTP genérico" loading="lazy" /><figcaption>Página de configuración del backend HTTP genérico</figcaption></figure>
...
- Usar el backend ACP en [ACP Chat](#doc/sidebar%2Facp-chat) o [ACP Skills](#doc/sidebar%2Facp-skills)
- Gestionar las ejecuciones de SkillRunner a través de la [Pestaña SkillRunner](#doc/sidebar%2Fskillrunner-tab)
- Usar los backends configurados para ejecutar tareas en la [Lista de Workflows](#doc/workflows%2Findex) y el [Dashboard](#doc/dashboard)
