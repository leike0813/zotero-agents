...
2. Abre **Herramientas → [Backend Manager](#doc/backends%2Fbackend-manager)**
...
- Las sesiones pueden gestionarse en [ACP Chat](#doc/sidebar%2Facp-chat)

## Próximos pasos

Una vez completada la configuración, puedes:
- Chatear con el backend en [ACP Chat en la barra lateral](#doc/sidebar%2Facp-chat)
- Ver las ejecuciones de skills ACP en el [Dashboard](#doc/dashboard)
- Usar el backend ACP para ejecutar tareas en la [Lista de Workflows](#doc/workflows%2Findex)
