...
<figure class="zs-doc-figure zs-doc-figure--icon"><img src="chrome://zotero-skills/content/help-docs/assets/img/icon_sidebar.webp" alt="Botón de la barra lateral" title="Botón de la barra lateral" loading="lazy" /><figcaption>Botón de la barra lateral</figcaption></figure>

<figure class="zs-doc-figure zs-doc-figure--icon"><img src="chrome://zotero-skills/content/help-docs/assets/img/icon_sidebar_glow.webp" alt="Estado del indicador de respuesta pendiente de la barra lateral" title="Estado del indicador de respuesta pendiente de la barra lateral" loading="lazy" /><figcaption>Estado del indicador de respuesta pendiente de la barra lateral</figcaption></figure>
...
- [Uso de ACP Chat](#doc/sidebar%2Facp-chat) — Interacción conversacional con el backend
- [ACP Skills](#doc/sidebar%2Facp-skills) — Gestionar ejecuciones de skills ACP
- [Pestaña SkillRunner](#doc/sidebar%2Fskillrunner-tab) — Gestionar ejecuciones de Skill-Runner

## Páginas relacionadas

- [Descripción general del Dashboard](#doc/dashboard) — Monitorización central y gestión de tareas
