...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/sidebar/acp-skills.webp" alt="Panel de ACP Skills" title="Panel de ACP Skills" loading="lazy" /><figcaption>Panel de ACP Skills</figcaption></figure>
...
El panel de ACP Skills requiere que se configure un [backend ACP](#doc/backends%2Facp) antes de su uso.
