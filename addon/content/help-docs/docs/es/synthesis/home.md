...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/synthesis/home.webp" alt="Panel Home de Synthesis" title="Panel Home de Synthesis" loading="lazy" /><figcaption>Panel Home de Synthesis</figcaption></figure>
...
Para la configuración y uso detallado de la sincronización WebDAV, consulta [WebDAV Sync](#doc/synthesis%2Fwebdav-sync).
...
Cada categoría muestra una insignia con el número de elementos pendientes. Haz clic para navegar a la sub-pestaña correspondiente en el [Centro de revisión](#doc/synthesis%2Freview).
...
- [WebDAV Sync](#doc/synthesis%2Fwebdav-sync) — Configurar sincronización entre dispositivos para datos de Synthesis
- [Centro de revisión](#doc/synthesis%2Freview) — Gestionar elementos de revisión de coincidencias de citas, conceptos y grafo de temas
- [Índice y Grafo de Citas](#doc/synthesis%2Findex-and-citation) — Gestionar el Índice de Referencias Canónicas
