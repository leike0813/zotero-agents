...
- [Panel Home](#doc/synthesis%2Fhome) — Ver estado de sincronización
- [Preferencias](#doc/preferences) — Configurar WebDAV sync
- [Git Sync](#doc/synthesis%2Fgit-sync) (obsoleto) — Referencia histórica
