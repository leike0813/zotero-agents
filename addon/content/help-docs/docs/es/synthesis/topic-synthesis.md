...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/synthesis/topic-graph.webp" alt="Vista de grafo de temas de Synthesis" title="Vista de grafo de temas de Synthesis" loading="lazy" /><figcaption>Vista de grafo de temas de Synthesis</figcaption></figure>
...
- [Backend Skill-Runner](#doc/backends%2Fskill-runner) configurado
- Artículos relevantes en la biblioteca
- Los artículos tienen resúmenes y análisis de citas generados (opcional, recomendado)

Este pipeline es orquestado por el workflow [Topic Synthesis Creation](#doc/workflows%2Ftopic-synthesis).
...
- [Topic Synthesis Creation](#doc/workflows%2Ftopic-synthesis) — Detalles del workflow para crear temas
- [Manuscript Literature Framing](#doc/workflows%2Fmanuscript-literature-framing) — Escribir artículos basándose en análisis temáticos
