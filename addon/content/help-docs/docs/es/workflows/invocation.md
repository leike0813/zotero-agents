...
<figure class="zs-doc-figure zs-doc-figure--icon"><img src="chrome://zotero-skills/content/help-docs/assets/img/icon_play.webp" alt="Botón de barra de herramientas para ejecutar flujo de trabajo" title="Botón de barra de herramientas para ejecutar flujo de trabajo" loading="lazy" /><figcaption>Botón de barra de herramientas para ejecutar flujo de trabajo</figcaption></figure>
