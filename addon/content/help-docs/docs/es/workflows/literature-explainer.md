...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/workflows/literature-explainer_note.webp" alt="Nota de estudio de Literature Explainer" title="Nota de estudio de Literature Explainer" loading="lazy" /><figcaption>Nota de estudio de Literature Explainer</figcaption></figure>
...
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Generar resúmenes de literatura automáticamente (se recomienda ejecutar primero)
- [Deep Reading](#doc/workflows%2Fliterature-deep-reading) — Generar una vista estructurada de lectura profunda
