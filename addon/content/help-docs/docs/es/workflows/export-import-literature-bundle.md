...
- [Export/Import Notes](#doc/workflows%2Fexport-import-notes) — Solo exportar o importar notas de análisis
- [Export Research Bundle](#doc/workflows%2Fexport-research-bundle) — Ensamblar un paquete de investigación de solo lectura para un proyecto de artículo (propósito diferente)
