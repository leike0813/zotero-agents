...
- [Tipos de solicitudes](#doc/workflows%2Fcustom%2Frequest-kinds) — Elegir backend de ejecución y tipo de solicitud
- [Empaquetado y despliegue](#doc/workflows%2Fcustom%2Fpackaging) — Publicar paquetes de workflows con localización
