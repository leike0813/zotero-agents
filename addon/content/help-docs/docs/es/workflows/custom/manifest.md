...
### <a id="selection-validation"></a>validateSelection — Validación de selección
...
> El **modo de ejecución** (`auto` / `interactive`) se ha movido a `request.create.mode` — consulta [Tipos de solicitud](#doc/workflows%2Fcustom%2Frequest-kinds).
...
Para información detallada sobre cada `kind`, consulta [Tipos de solicitud](#doc/workflows%2Fcustom%2Frequest-kinds).
...
Consulta la página de [Localización](#doc/workflows%2Fcustom%2Flocalization) para información detallada.
...
- [Sistema de Hooks](#doc/workflows%2Fcustom%2Fhooks) — Conoce las firmas de API y métodos de escritura de cada Hook
- [Sistema de parámetros](#doc/workflows%2Fcustom%2Fparameters) — Tipos de parámetros, valores enum, fuentes de opciones dinámicas
- [Selección y contexto](#doc/workflows%2Fcustom%2Fselection-context) — Cómo obtener información sobre los elementos seleccionados por el usuario
