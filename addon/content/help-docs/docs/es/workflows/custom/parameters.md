...
Consulta la página de [Localización](#doc/workflows%2Fcustom%2Flocalization) para el mecanismo completo de localización.

## Próximos pasos

- [Contexto de selección](#doc/workflows%2Fcustom%2Fselection-context) — Comprende cómo se pasa la selección de elementos del usuario al workflow
- [Tipos de solicitud](#doc/workflows%2Fcustom%2Frequest-kinds) — Métodos de paso de parámetros para diferentes tipos de solicitud
