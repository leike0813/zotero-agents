...
1. Haz clic en el icono <figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/zotero-addons_icon.webp" alt="" title="" loading="lazy" /></figure> en la barra de herramientas de Zotero para abrir el marketplace
...
Si el menú de clic derecho solo muestra la opción **📦 Install Official Workflow Packages**, los paquetes oficiales aún no han sido instalados — sigue las instrucciones anteriores para instalarlos. Después de una instalación exitosa, dirígete a [Primeros pasos](#doc/getting-started) para configurar un backend y ejecutar tu primer flujo de trabajo.
