...
- [Contesto di selezione](#doc/workflows%2Fcustom%2Fselection-context) — Struttura dettagliata del selectionContext
- [Riferimento API host](#doc/workflows%2Fcustom%2Fhost-api) — Riferimento API completo
- [Pacchettizzazione e distribuzione](#doc/workflows%2Fcustom%2Fpackaging) — Come pacchettizzare e distribuire i Workflow
