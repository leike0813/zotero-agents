...
- [Riferimento completo del manifesto del Workflow](#doc/workflows%2Fcustom%2Fmanifest) — Tutti i campi in workflow.json
- [Riferimento dell'API host](#doc/workflows%2Fcustom%2Fhost-api) — Tutte le API disponibili negli Hook
