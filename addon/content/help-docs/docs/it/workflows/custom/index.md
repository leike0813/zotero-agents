...
- [Scrittura del manifesto del Workflow](#doc/workflows%2Fcustom%2Fmanifest) — Spiegazione dettagliata di ogni campo in workflow.json
- [Sistema di Hook](#doc/workflows%2Fcustom%2Fhooks) — Come scrivere gli Hook per ogni fase
- [Sistema dei parametri](#doc/workflows%2Fcustom%2Fparameters) — Definire parametri configurabili
