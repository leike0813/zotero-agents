...
- [Tipi di richiesta](#doc/workflows%2Fcustom%2Frequest-kinds) — Scegli il backend di esecuzione e il tipo di richiesta
- [Pacchettizzazione e distribuzione](#doc/workflows%2Fcustom%2Fpackaging) — Pubblica pacchetti di Workflow con localizzazione
