...
> **Modalità di esecuzione** (`auto` / `interactive`) è stato spostato in `request.create.mode` — vedere [Tipi di richiesta](#doc/workflows%2Fcustom%2Frequest-kinds).
...
Per informazioni dettagliate su ciascun `kind`, vedere [Tipi di richiesta](#doc/workflows%2Fcustom%2Frequest-kinds).
...
Vedere la pagina [Localizzazione](#doc/workflows%2Fcustom%2Flocalization) per informazioni dettagliate.
...
- [Sistema Hook](#doc/workflows%2Fcustom%2Fhooks) — Conoscere le firme API e i metodi di scrittura per ciascun Hook
- [Sistema dei parametri](#doc/workflows%2Fcustom%2Fparameters) — Tipi di parametri, valori enum, origini delle opzioni dinamiche
- [Selezione e contesto](#doc/workflows%2Fcustom%2Fselection-context) — Come ottenere informazioni sugli elementi selezionati dall'utente
