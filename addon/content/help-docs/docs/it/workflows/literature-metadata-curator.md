...
- [Literature Search & Ingest](#doc/workflows%2Fliterature-search-ingest) — Cercare nuova letteratura e acquisirla in Zotero
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Generare sintesi e analisi delle citazioni da PDF/Markdown
- [Tag Regulator](#doc/workflows%2Ftag-regulator) — Normalizzare i tag dopo il completamento dei metadati
