...
- [MinerU PDF Parsing](#doc/workflows%2Fmineru) — Convertire prima il PDF in Markdown per una migliore qualità di traduzione
- [Literature Analysis](#doc/workflows%2Fliterature-analysis) — Generare sintesi letteraria e artefatti di analisi
