...
2. Eseguire [Analisi della letteratura](#doc/workflows%2Fliterature-analysis) + [Regolatore dei tag](#doc/workflows%2Ftag-regulator) su tutti gli articoli
3. Eseguire la Corrispondenza avanzata nel Synthesis Workbench e gestire gli elementi di approvazione
4. Creare diverse [Sintesi dell'argomento](#doc/workflows%2Ftopic-synthesis) correlate
:::
...
- [Analisi della letteratura](#doc/workflows%2Fliterature-analysis) — Stabilisce una base di conoscenza strutturata per gli articoli
- [Sintesi dell'argomento](#doc/workflows%2Ftopic-synthesis) — Crea prima le sintesi dell'argomento, poi scrivi l'articolo basandoti sui risultati dell'analisi
