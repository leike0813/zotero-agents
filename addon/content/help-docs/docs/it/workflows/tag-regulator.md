...
- **Vocabolario controllato**: È necessario creare prima un vocabolario controllato; vedi [Gestione dei tag](#doc/synthesis%2Ftags)
...
- [Gestione dei tag](#doc/synthesis%2Ftags) — Gestisci il vocabolario controllato dei tag
