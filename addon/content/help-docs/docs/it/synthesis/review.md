...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/synthesis/review.webp" alt="Hub di Revisione di Synthesis" title="Hub di Revisione di Synthesis" loading="lazy" /><figcaption>Hub di Revisione di Synthesis</figcaption></figure>
...
Vedere [Indice e Grafo delle Citazioni](#doc/synthesis%2Findex-and-citation) per le descrizioni dei livelli di confidenza. Le corrispondenze deterministiche e ad alta confidenza vengono generalmente elaborate automaticamente; le corrispondenze a confidenza media e inferiore entrano nella coda di revisione.
...
- [Base di Conoscenza dei Concetti](#doc/synthesis%2Fconcepts) — Gestire concetti, sensi, alias
- [Argomenti](#doc/synthesis%2Ftopic-synthesis) — Gestire le sintesi degli argomenti
