...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/synthesis/index.webp" alt="Vista Registry dell&#39;Indice di Synthesis" title="Vista Registry dell&#39;Indice di Synthesis" loading="lazy" /><figcaption>Vista Registry dell&#39;Indice di Synthesis</figcaption></figure>
...
Nell'[Hub di Revisione](#doc/synthesis%2Freview), è possibile visualizzare ed elaborare le proposte di corrispondenza delle citazioni, accettandole o rifiutandole una per una.
...
<figure class="zs-doc-figure"><img src="chrome://zotero-skills/content/help-docs/assets/img/docs/synthesis/citation-graph.webp" alt="Grafo delle Citazioni di Synthesis" title="Grafo delle Citazioni di Synthesis" loading="lazy" /><figcaption>Grafo delle Citazioni di Synthesis</figcaption></figure>
...
- [Hub di Revisione](#doc/synthesis%2Freview) — Revisionare le proposte di corrispondenza e deduplicazione delle citazioni
- [Creare una Sintesi di Argomento](#doc/synthesis%2Ftopic-synthesis) — Creare analisi per argomento basate sulle reti di citazioni
- [Dashboard Home](#doc/synthesis%2Fhome) — Visualizzare le metriche di informazione sulla libreria
- [WebDAV Sync](#doc/synthesis%2Fwebdav-sync) — Sincronizzare i dati di associazione delle citazioni tra dispositivi
