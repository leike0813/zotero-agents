...
**Utilizzare invece [WebDAV Sync](#doc/synthesis%2Fwebdav-sync).**
...
- [Dashboard Home](#doc/synthesis%2Fhome) — Visualizzare il pannello di stato della sincronizzazione
- [Gestione Tag](#doc/synthesis%2Ftags) — Gestire il vocabolario controllato dei tag
- [Preferenze](#doc/preferences) — Configurare i parametri del repository Git
