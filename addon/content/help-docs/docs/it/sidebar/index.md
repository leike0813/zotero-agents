...
<figure class="zs-doc-figure zs-doc-figure--icon"><img src="chrome://zotero-skills/content/help-docs/assets/img/icon_sidebar.webp" alt="Pulsante della barra laterale nella barra degli strumenti" title="Pulsante della barra laterale nella barra degli strumenti" loading="lazy" /><figcaption>Pulsante della barra laterale nella barra degli strumenti</figcaption></figure>

<figure class="zs-doc-figure zs-doc-figure--icon"><img src="chrome://zotero-skills/content/help-docs/assets/img/icon_sidebar_glow.webp" alt="Stato dell&#39;indicatore di attesa risposta della barra laterale" title="Stato dell&#39;indicatore di attesa risposta della barra laterale" loading="lazy" /><figcaption>Stato dell&#39;indicatore di attesa risposta della barra laterale</figcaption></figure>
...
- [Utilizzo di ACP Chat](#doc/sidebar%2Facp-chat) — Interazione conversazionale con il backend
- [ACP Skills](#doc/sidebar%2Facp-skills) — Gestire le esecuzioni degli skill ACP
- [Scheda SkillRunner](#doc/sidebar%2Fskillrunner-tab) — Gestire le esecuzioni di Skill-Runner

## Pagine correlate

- [Panoramica della Dashboard](#doc/dashboard) — Monitoraggio centrale e gestione delle attività
