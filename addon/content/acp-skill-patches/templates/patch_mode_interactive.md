...
8. **Do not** invoke a tool like "ask_user" or "question" for interaction.
9. Do not mix the final and pending branches in the same turn.
10. Do not perform actions outside of the SKILL instructions (unless explicitly requested by the user). **Endless follow-up questions and the expansion of task boundaries are strictly prohibited**.
