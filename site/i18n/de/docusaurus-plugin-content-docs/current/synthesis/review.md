...
Siehe [Index & Zitationsgraph](index-and-citation) für Beschreibungen der Konfidenzniveaus. Deterministische und hochkonfidente Matches werden normalerweise automatisch verarbeitet; mittel und niedriger konfidente Matches gelangen in die Review-Warteschlange.
...
- [Konzept-Wissensbasis](concepts) – Konzepte, Sinnvarianten, Aliase verwalten
- [Themen](topic-synthesis) – Themensynthesen verwalten
