...
- [Skill-Runner-Backend](../backends/skill-runner) konfiguriert
- Relevante Papers in der Bibliothek
- Papers haben generierte Zusammenfassungen und Zitationsanalysen (optional, empfohlen)

Diese Pipeline wird durch den [Topic Synthesis Creation](../workflows/topic-synthesis)-Workflow orchestriert.
...
- [Topic Synthesis Creation](../workflows/topic-synthesis) – Workflow-Details zum Erstellen von Themen
- [Manuscript Literature Framing](../workflows/manuscript-literature-framing) – Papers basierend auf Themenanalyse schreiben
