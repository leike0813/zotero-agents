...
**Bitte verwenden Sie stattdessen [WebDAV Sync](webdav-sync).**
...
- [Home-Dashboard](home) – Das Sync-Status-Panel anzeigen
- [Tag-Verwaltung](tags) – Das kontrollierte Tag-Vokabular verwalten
- [Einstellungen](../preferences) – Git-Repository-Parameter konfigurieren
