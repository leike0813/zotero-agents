...
Interaktiv ein kontrolliertes Tag-Vokabular für ein Forschungsgebiet zusammen mit der KI erstellen. Empfohlen, vor der ersten [Literature Analysis](literature-analysis) auszuführen, um eine Grundlage für die anschließende automatische Tag-Regulierung zu schaffen.
...
- [Literature Analysis](literature-analysis) — Kann während der Analyse automatisch die Tag-Regulierung kaskadieren
- [Tag Regulator](tag-regulator) — Tag-Regulierung auf bestehende Literatur anwenden
