...
Siehe die Seite [Lokalisierung](localization) für den vollständigen Lokalisierungsmechanismus.

## Nächste Schritte

- [Auswahlkontext](selection-context) — Verstehen, wie die Elementauswahl des Benutzers an den Workflow übergeben wird
- [Anfragetypen](request-kinds) — Parameterübergabemethoden für verschiedene Anfragetypen
