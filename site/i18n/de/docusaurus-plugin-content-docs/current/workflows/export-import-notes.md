...
Von [Literature Analysis](literature-analysis) erstellte Notizen werden aus Backend-Daten **gerendert**; das direkte Ändern des Notizinhalts ändert nicht die Backend-Daten. Wenn Sie Analyseergebnisse bearbeiten möchten, ist der korrekte Ansatz: **Notizen exportieren** → die exportierten Dateien ändern → **Notizen importieren** zum Reimportieren verwenden.
:::
...
- [Literature Analysis](literature-analysis) — Die drei Arten von exportierbaren Notizen erstellen
