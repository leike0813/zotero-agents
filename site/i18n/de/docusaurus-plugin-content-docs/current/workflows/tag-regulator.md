...
- **Kontrolliertes Vokabular**: Ein kontrolliertes Vokabular muss zuerst erstellt werden; siehe [Tags-Verwaltung](../synthesis/tags)
...
- [Tags-Verwaltung](../synthesis/tags) — Das kontrollierte Tag-Vokabular verwalten
