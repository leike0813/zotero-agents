...
![ACP-Backend-Konfigurationsseite](/img/docs/backends/backend-manager_ACP.png)
...
![SkillRunner-Backend-Konfigurationsseite](/img/docs/backends/backend-manager_skillrunner.png)
...
![Generisches-HTTP-Backend-Konfigurationsseite](/img/docs/backends/backend-manager_generic-HTTP.png)
...
- Das ACP-Backend im [ACP-Chat](../sidebar/acp-chat) oder [ACP-Skills](../sidebar/acp-skills) verwenden
- SkillRunner-Ausführungen über die [SkillRunner-Registerkarte](../sidebar/skillrunner-tab) verwalten
- Die konfigurierten Backends zur Ausführung von Aufgaben in der [Workflow-Liste](../workflows/) und im [Dashboard](../dashboard) verwenden
