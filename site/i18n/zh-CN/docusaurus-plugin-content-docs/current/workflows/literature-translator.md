...
将文献附件（Markdown 或 PDF）翻译成指定的目标语言，生成翻译后的 Markdown 文件和双语对齐数据。强烈建议先使用 [MinerU](mineru) 将 PDF 转换为 Markdown，以获得显著更好的翻译质量。
...
- [MinerU PDF Parsing](mineru) — 先将 PDF 转换为 Markdown 以获得更好的翻译质量
- [Literature Analysis](literature-analysis) — 生成文献摘要和分析产物
