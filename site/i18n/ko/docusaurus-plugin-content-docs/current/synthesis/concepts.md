...
개념 지식 베이스에 대한 변경 제안(새 개념, 새 의미, 새 관계)은 [리뷰 허브](review)의 개념 리뷰 탭에 나타납니다. 이러한 제안을 검토하고 수락 여부를 결정할 수 있습니다.
...
- [리뷰 허브](review) — 개념 제안 리뷰
- [태그 관리](tags) — 제어된 태그 어휘 관리
- [토픽 통합](topic-synthesis) — 토픽 통합 생성 시 개념 지식 활용
