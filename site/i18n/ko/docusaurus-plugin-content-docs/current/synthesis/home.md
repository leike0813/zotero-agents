...
[WebDAV 동기화](webdav-sync)(권장) 또는 [Git 동기화](git-sync)(사용 중단됨)가 구성된 경우, 홈 페이지에 동기화 상태 패널이 표시됩니다:
...
WebDAV 동기화의 자세한 구성 및 사용 방법은 [WebDAV 동기화](webdav-sync)를 참조하세요.
...
역사적 참고를 위해 [Git 동기화](git-sync)를 참조하세요.
...
각 카테고리에는 대기 중인 항목 수가 배지로 표시됩니다. 클릭하면 [리뷰 허브](review)의 해당 서브 탭으로 이동합니다.
...
- [WebDAV 동기화](webdav-sync) — Synthesis 데이터의 크로스 디바이스 동기화 구성
- [리뷰 허브](review) — 인용 매치, 개념 및 토픽 그래프 리뷰 항목 처리
- [인덱스 & 인용 그래프](index-and-citation) — Canonical Reference Index 관리
