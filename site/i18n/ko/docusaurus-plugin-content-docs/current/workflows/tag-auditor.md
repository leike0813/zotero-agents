...
- 백엔드 연결 불필요
- **제어된 어휘**: 제어된 태그 어휘를 먼저 정의해야 합니다. [태그 관리](../synthesis/tags) 참조

## 관련 Workflow

- [Tag Regulator](tag-regulator) — 제어된 어휘를 기반으로 태그 정규화 및 새 태그 추론
- [Tag Bootstrapper](tag-bootstrapper) — 대화형으로 제어된 태그 어휘 생성
