...
![Synthesis Concepts ページ](/img/docs/synthesis/concepts.png)
...
概念知識ベースへの変更提案（新概念、新意義、新関係）は、[レビューハブ](review)の概念レビュータブに表示される。これらの提案をレビューし、承認するかどうかを決定できる。
...
- [レビューハブ](review) — 概念提案をレビュー
- [タグ管理](tags) — 統制タグ語彙を管理
- [トピック統合](topic-synthesis) — 概念知識を活用してトピック統合を作成
