...
1. 十分な数の関連論文を収集・取り込む
2. すべての論文で[Literature Analysis](literature-analysis) + [Tag Regulator](tag-regulator)を実行
3. Synthesis WorkbenchでAdvance Matchingを実行し、承認アイテムを処理
4. 関連する[Topic Synthesis](topic-synthesis)をいくつか作成
:::
...
- [Literature Analysis](literature-analysis) — 論文の構造化された知識基盤を確立
- [Topic Synthesis](topic-synthesis) — トピック統合を先に作成し、分析結果に基づいて論文を執筆
