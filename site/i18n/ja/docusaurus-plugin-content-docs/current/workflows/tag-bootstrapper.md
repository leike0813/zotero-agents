...
AIと共に研究ドメインの統制されたタグ語彙を対話的に作成します。最初の[Literature Analysis](literature-analysis)の前に実行し、その後の自動タグ正規化の基盤を確立することを推奨します。
...
- [Literature Analysis](literature-analysis) — 分析時にタグ正規化を自動的にカスケード可能
- [Tag Regulator](tag-regulator) — 既存の文献に対してタグ正規化を実行
