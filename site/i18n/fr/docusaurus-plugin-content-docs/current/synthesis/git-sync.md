...
**Veuillez utiliser la [Synchronisation WebDAV](webdav-sync) à la place.**
...
- [Tableau de bord Home](home) — Voir le panneau d'état de la synchronisation
- [Gestion des balises](tags) — Gérer le vocabulaire contrôlé de balises
- [Préférences](../preferences) — Configurer les paramètres du dépôt Git
