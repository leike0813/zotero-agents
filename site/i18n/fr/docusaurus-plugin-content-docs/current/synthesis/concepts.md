...
Les propositions de modification de la base de connaissances conceptuelle (nouveaux concepts, nouveaux sens, nouvelles relations) apparaissent dans l'onglet de révision Concepts du [Centre de révision](review). Vous pouvez examiner et décider d'accepter ces propositions.
...
- [Centre de révision](review) — Réviser les suggestions de concepts
- [Gestion des balises](tags) — Gérer le vocabulaire contrôlé de balises
- [Synthèse de sujets](topic-synthesis) — Exploiter les connaissances conceptuelles lors de la création de synthèses de sujets
