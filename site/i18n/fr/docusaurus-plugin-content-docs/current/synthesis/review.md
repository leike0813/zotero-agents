...
Voir [Index et graphe de citations](index-and-citation) pour les descriptions des niveaux de confiance. Les correspondances déterministes et à haute confiance sont généralement traitées automatiquement ; les correspondances à confiance moyenne et inférieure entrent dans la file de révision.
...
- [Base de connaissances conceptuelle](concepts) — Gérer les concepts, sens et alias
- [Sujets](topic-synthesis) — Gérer les synthèses de sujets
