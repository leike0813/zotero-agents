...
Si la [synchronisation WebDAV](webdav-sync) (recommandée) ou la [synchronisation Git](git-sync) (obsolète) est configurée, la page Home affiche un panneau d'état de la synchronisation :
...
Pour la configuration détaillée et l'utilisation de la synchronisation WebDAV, voir [Synchronisation WebDAV](webdav-sync).
...
Voir [Synchronisation Git](git-sync) pour référence historique.
...
Chaque catégorie affiche un badge avec le nombre d'éléments en attente. Cliquez pour naviguer vers le sous-onglet correspondant dans le [Centre de révision](review).
...
- [Synchronisation WebDAV](webdav-sync) — Configurer la synchronisation multi-appareils des données Synthesis
- [Centre de révision](review) — Traiter les éléments de révision des correspondances de citations, des concepts et du graphe de sujets
- [Index et graphe de citations](index-and-citation) — Gérer l'index de référence canonique
