...
![Guide d'Ouverture de Deep Reading](/img/docs/workflows/literature-deep-reading_1.png)

![Lecture Dynamique Bilingue de Deep Reading](/img/docs/workflows/literature-deep-reading_2.png)

![Lecture des Résumés de Références de Deep Reading](/img/docs/workflows/literature-deep-reading_3.png)

![Sous-graphe 2-hop de Références de Deep Reading](/img/docs/workflows/literature-deep-reading_4.png)
...
- [Literature Analysis](literature-analysis) — Générer automatiquement des résumés littéraires et des analyses de citation
