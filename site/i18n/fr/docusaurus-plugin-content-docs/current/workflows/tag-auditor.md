...
- **Vocabulaire contrôlé** : Un vocabulaire de balises contrôlé doit d'abord être défini ; voir [Gestion des balises](../synthesis/tags)

## Workflows connexes

- [Tag Regulator](tag-regulator) — Normaliser les balises selon le vocabulaire contrôlé et inférer de nouvelles balises
- [Tag Bootstrapper](tag-bootstrapper) — Créer interactivement un vocabulaire de balises contrôlé
