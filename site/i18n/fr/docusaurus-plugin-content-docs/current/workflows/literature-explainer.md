...
![Note d'Étude de Literature Explainer](/img/docs/workflows/literature-explainer_note.png)
...
- [Literature Analysis](literature-analysis) — Générer automatiquement des résumés littéraires (recommandé d'exécuter en premier)
- [Deep Reading](literature-deep-reading) — Générer une vue structurée de lecture approfondie
