...
- [Literature Search & Ingest](literature-search-ingest) — Rechercher de la nouvelle littérature et l'ingérer dans Zotero
- [Literature Analysis](literature-analysis) — Générer un résumé et une analyse de citation à partir de PDF/Markdown
- [Tag Regulator](tag-regulator) — Normaliser les balises une fois les métadonnées complètes
