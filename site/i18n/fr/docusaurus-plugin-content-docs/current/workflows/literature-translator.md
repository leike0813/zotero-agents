...
- [MinerU PDF Parsing](mineru) — Convertir d'abord le PDF en Markdown pour une meilleure qualité de traduction
- [Literature Analysis](literature-analysis) — Générer un résumé de littérature et des artefacts d'analyse
