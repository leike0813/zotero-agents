...
- [Localisation](localization) — Ajouter le support multilingue aux workflows
- [Types de requêtes](request-kinds) — Choisir le backend d'exécution et le type de requête appropriés
- [Débogage et tests](debugging) — Vérifier la correctness des workflows
