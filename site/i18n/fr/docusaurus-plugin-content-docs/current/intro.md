...
![Affiche de l'atelier de recherche Zotero Agents](/img/poster.png)
...
- [Guide d'installation](/installation) — Installer le plugin et ses dépendances
- [Premiers pas](/getting-started) — Configurer votre premier backend et exécuter un skill
- [Configuration des backends](/backends/) — Découvrir les trois types de backend pris en charge

## Documentation

| Section | Description |
|---------|-------------|
| [Guide d'installation](/installation) | Installation du plugin, installation des packages de workflows officiels, déploiement du backend Skill-Runner |
| [Lecteur Markdown intégré](/markdown-reader) | Double-cliquez sur les fichiers `.md` pour les ouvrir dans Zotero, avec plan, recherche et rendu mathématique |
| [Configuration des backends](/backends/) | Guide de configuration pour les backends ACP, Skill-Runner et Generic HTTP |
| [Workflow](/workflows/) | Introduction aux workflows et guide d'utilisation |
| [Tableau de bord](/dashboard) | Guide d'utilisation du panneau de monitoring central |
| [Barre latérale et Chat ACP](/sidebar/) | Panneau latéral et fonctionnalités de conversation |
| [Synthesis Workbench](/synthesis/) | Guide d'utilisation du banc de synthèse |
| [Préférences](/preferences) | Référence des paramètres du plugin |
