...
![Panneau SkillRunner](/img/docs/sidebar/skillrunner-tab.png)
...
Avant d'utiliser l'onglet SkillRunner, un [backend Skill-Runner](../backends/skill-runner) doit être configuré.
