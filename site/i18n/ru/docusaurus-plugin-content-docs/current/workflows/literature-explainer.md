...
![Конспект Пояснителя литературы](/img/docs/workflows/literature-explainer_note.png)
...
- [Анализ литературы](literature-analysis) — Автоматическая генерация дайджестов литературы (рекомендуется запустить сначала)
- [Глубокое чтение](literature-deep-reading) — Генерация структурированного представления глубокого чтения
