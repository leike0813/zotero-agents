...
Перевести вложение литературы (Markdown или PDF) на указанный целевой язык, создав переведенный файл Markdown и двуязычные данные выравнивания. Настоятельно рекомендуется сначала преобразовать PDF в Markdown с помощью [MinerU](mineru) для значительно лучшего качества перевода.
...
- [MinerU PDF Parsing](mineru) — Сначала преобразовать PDF в Markdown для лучшего качества перевода
- [Literature Analysis](literature-analysis) — Генерация дайджеста литературы и артефактов анализа
