...
- [Export/Import Notes](export-import-notes) — Esportare o importare solo note di analisi
- [Export Research Bundle](export-research-bundle) — Assemblare un bundle di ricerca di sola lettura per un progetto di articolo (scopo diverso)
