...
- [Literature Analysis](literature-analysis) — Generare artefatti di sintesi e analisi delle citazioni che possono essere inclusi nel bundle
- [Literature Search & Ingest](literature-search-ingest) — Cercare e acquisire letteratura mancante prima di assemblare il bundle
- [Export/Import Literature Bundle](export-import-literature-bundle) — Esportare bundle ZIP portabili di elementi Zotero (scopo diverso)
