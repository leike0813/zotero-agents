...
![Pagina panoramica della Sintesi dell'argomento](/img/docs/workflows/topic-synthesis_overview.png)

![Pagina Tassonomia della Sintesi dell'argomento](/img/docs/workflows/topic-synthesis_taxonomy.png)

![Pagina Affermazioni della Sintesi dell'argomento](/img/docs/workflows/topic-synthesis_claims.png)

![Pagina Confronti della Sintesi dell'argomento](/img/docs/workflows/topic-synthesis_compare.png)

![Pagina Direzioni future della Sintesi dell'argomento](/img/docs/workflows/topic-synthesis_future-directions.png)

![Pagina Copertura della Sintesi dell'argomento](/img/docs/workflows/topic-synthesis_coverage.png)

![Pagina Rapporto della Sintesi dell'argomento](/img/docs/workflows/topic-synthesis_report.png)

![Pagina Riferimenti della Sintesi dell'argomento](/img/docs/workflows/topic-synthesis_references.png)

![Sottografo degli articoli della Sintesi dell'argomento](/img/docs/workflows/topic-synthesis_subgraph.png)
...
1. Assicurarsi che tutti gli articoli correlati siano stati elaborati tramite [Analisi della letteratura](literature-analysis)
2. Assicurarsi che gli articoli correlati siano stati elaborati tramite [Regolatore dei tag](tag-regulator)
...
- [Panoramica del Synthesis Workbench](../synthesis/) — Guida all'uso del Synthesis Workbench
- [Strutturazione della letteratura per il manoscritto](manuscript-literature-framing) — Scrivi le introduzioni degli articoli basandoti sui risultati della Sintesi dell'argomento
