...
Creare in modo interattivo un vocabolario controllato di tag per un dominio di ricerca con l'AI. Si consiglia di eseguirlo prima della tua prima [Analisi della letteratura](literature-analysis) per stabilire una base per la successiva regolazione automatica dei tag.
...
- [Analisi della letteratura](literature-analysis) — Può attivare automaticamente la regolazione dei tag a cascata durante l'analisi
- [Regolatore dei tag](tag-regulator) — Esegui la regolazione dei tag sulla letteratura esistente
