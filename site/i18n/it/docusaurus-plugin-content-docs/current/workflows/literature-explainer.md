...
![Nota di studio dello Spiegatore della letteratura](/img/docs/workflows/literature-explainer_note.png)
...
- [Analisi della letteratura](literature-analysis) — Genera automaticamente riassunti della letteratura (si consiglia di eseguirlo prima)
- [Lettura approfondita](literature-deep-reading) — Genera una vista strutturata di lettura approfondita
