...
- **Vocabolario controllato**: Un vocabolario di tag controllato deve essere definito prima; vedere [Gestione tag](../synthesis/tags)

## Workflow correlati

- [Tag Regulator](tag-regulator) — Normalizzare i tag in base al vocabolario controllato e inferire nuovi tag
- [Tag Bootstrapper](tag-bootstrapper) — Creare interattivamente un vocabolario di tag controllato
