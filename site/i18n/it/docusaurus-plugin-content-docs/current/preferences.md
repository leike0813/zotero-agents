...
![Pagina Impostazioni Workflow](/img/docs/preferences_workflow.png)
...
![Contenuto Pacchetto di Workflow Ufficiale](/img/docs/preferences_official-workflow-contents.png)
...
Un servizio HTTP integrato per l'accesso degli strumenti AI esterni e della CLI alla biblioteca Zotero. Vedi [Host Bridge](backends/host-bridge) per i dettagli.
...
![Pagina Impostazioni Host Bridge](/img/docs/preferences_host-bridge.png)
...
![Area Azioni Pericolose Host Bridge Espansa](/img/docs/preferences_host-bridge_expand.png)

## Backend Locale SkillRunner

> ⚠️ Questa modalità è adatta solo per utenti che non hanno familiarità con l'installazione di strumenti agent e non possono utilizzare Docker. Se hai già un agent ACP o puoi utilizzare Docker, preferisci il [backend ACP](backends/acp) o il [Skill-Runner distribuito con Docker](backends/skill-runner#recommended-docker-persistent-deployment).
...
![Pagina Impostazioni Backend Locale SkillRunner](/img/docs/preferences_skillrunner-local-backend.png)
...
Soluzione di sincronizzazione multi-dispositivo per il Synthesis Workbench, in sostituzione della deprecata Sincronizzazione Git. Vedi [Sincronizzazione WebDAV](synthesis/webdav-sync) per i dettagli.
...
![Pagina Impostazioni Sincronizzazione WebDAV](/img/docs/preferences_WebDAV-sync.png)
...
![Pagina Gestione Dati Runtime e Persistenza](/img/docs/preferences_storage-and-persistence.png)
