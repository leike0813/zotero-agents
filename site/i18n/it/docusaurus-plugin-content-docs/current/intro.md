...
![Poster del banco di lavoro di ricerca Zotero Agents](/img/poster.png)
...
> **Versioni Zotero supportate**: questo plugin supporta Zotero 7, 9 e 10. Su Windows e Linux vengono testate le versioni rappresentative 7.0.32, 9.0.6 e 10.0.1. Per Zotero 10 su macOS, l'evidenza attuale è uno smoke test formale dell'XPI non bloccante; non implica la copertura di tutte le precedenti versioni di manutenzione.

:::tip Suggerimento
Il plugin viene distribuito **senza logica di business integrata**. Tutti i workflow sono forniti tramite **pacchetti di workflow ufficiali** separati che gli utenti devono scaricare e installare dopo aver installato il plugin. Vedi la [Guida all'Installazione](/installation) per i dettagli.
:::
...
- [Guida all'Installazione](/installation) — Installa il plugin e le sue dipendenze
- [Primi Passi](/getting-started) — Configura il tuo primo backend ed esegui una skill
- [Configurazione Backend](/backends/) — Scopri i tre tipi di backend supportati

## Documentazione

| Sezione | Descrizione |
|---------|-------------|
| [Guida all'Installazione](/installation) | Installazione del plugin, installazione dei pacchetti di workflow ufficiali, distribuzione del backend Skill-Runner |
| [Lettore Markdown Integrato](/markdown-reader) | Doppio clic sui file `.md` per aprirli in Zotero, con struttura, ricerca e rendering matematico |
| [Configurazione Backend](/backends/) | Guida alla configurazione per i backend ACP, Skill-Runner e Generic HTTP |
| [Workflow](/workflows/) | Introduzione ai workflow e guida all'invocazione |
| [Dashboard](/dashboard) | Guida all'uso del pannello di monitoraggio centrale |
| [Barra Laterale & ACP Chat](/sidebar/) | Pannello della barra laterale e funzionalità di conversazione |
| [Synthesis Workbench](/synthesis/) | Guida all'uso del banco di lavoro di sintesi |
| [Preferenze](/preferences) | Riferimento alle impostazioni del plugin |
