...
![Pannello SkillRunner](/img/docs/sidebar/skillrunner-tab.png)
...
Prima di utilizzare la scheda SkillRunner, è necessario configurare un [backend Skill-Runner](../backends/skill-runner).
