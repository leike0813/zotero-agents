...
![Pagina Concetti di Synthesis](/img/docs/synthesis/concepts.png)
...
Le proposte di modifica alla base di conoscenza dei concetti (nuovi concetti, nuovi sensi, nuove relazioni) appaiono nella scheda di revisione Concetti dell'[Hub di Revisione](review). È possibile esaminare e decidere se accettare queste proposte.
...
- [Hub di Revisione](review) — Revisionare i suggerimenti sui concetti
- [Gestione Tag](tags) — Gestire il vocabolario controllato dei tag
- [Sintesi degli Argomenti](topic-synthesis) — Sfruttare la conoscenza dei concetti nella creazione di sintesi di argomenti
