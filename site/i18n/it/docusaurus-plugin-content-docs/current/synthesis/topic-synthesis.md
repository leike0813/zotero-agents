...
![Vista Grafo degli Argomenti di Synthesis](/img/docs/synthesis/topic-graph.png)
...
- Backend [Skill-Runner](../backends/skill-runner) configurato
- Articoli pertinenti nella libreria
- Gli articoli hanno generato riassunti e analisi delle citazioni (opzionale, consigliato)

Questa pipeline è orchestrata dal workflow [Creazione Sintesi di Argomento](../workflows/topic-synthesis).
...
- [Creazione Sintesi di Argomento](../workflows/topic-synthesis) — Dettagli del workflow per la creazione degli argomenti
- [Manuscript Literature Framing](../workflows/manuscript-literature-framing) — Scrivere articoli basati sull'analisi degli argomenti
