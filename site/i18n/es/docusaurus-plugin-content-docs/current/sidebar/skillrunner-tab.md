...
![Panel de SkillRunner](/img/docs/sidebar/skillrunner-tab.png)
...
Antes de usar la pestaña SkillRunner, se debe configurar un [backend Skill-Runner](../backends/skill-runner).
