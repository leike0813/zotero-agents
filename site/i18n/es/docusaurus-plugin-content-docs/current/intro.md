...
![Póster del banco de trabajo de investigación Zotero Agents](/img/poster.png)
...
> **Versiones de Zotero compatibles**: Este complemento es compatible con Zotero 7, 9 y 10. En Windows y Linux se prueban las versiones representativas 7.0.32, 9.0.6 y 10.0.1. Para Zotero 10 en macOS, la evidencia actual es una prueba de humo formal del XPI no bloqueante; no implica cobertura de todas las versiones de parche anteriores.
...
- [Guía de instalación](/installation) — Instala el complemento y sus dependencias
- [Primeros pasos](/getting-started) — Configura tu primer backend y ejecuta un skill
- [Configuración de backends](/backends/) — Conoce los tres tipos de backend soportados

## Documentación

| Sección | Descripción |
|---------|-------------|
| [Guía de instalación](/installation) | Instalación del complemento, instalación de paquetes de flujo de trabajo oficiales, despliegue del backend Skill-Runner |
| [Lector de Markdown integrado](/markdown-reader) | Haz doble clic en archivos `.md` para abrirlos en Zotero, con esquema, búsqueda y renderizado matemático |
| [Configuración de backends](/backends/) | Guía de configuración para backends ACP, Skill-Runner y Generic HTTP |
| [Workflow](/workflows/) | Introducción a flujos de trabajo y guía de invocación |
| [Dashboard](/dashboard) | Guía de uso del panel de monitoreo central |
| [Barra lateral y ACP Chat](/sidebar/) | Panel lateral y funciones de conversación |
| [Synthesis Workbench](/synthesis/) | Guía de uso del banco de trabajo de síntesis |
| [Preferencias](/preferences) | Referencia de configuración del complemento |
