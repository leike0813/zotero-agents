...
- [Literature Analysis](literature-analysis) — Generar artefactos de resumen y análisis de citas que se pueden incluir en el paquete
- [Literature Search & Ingest](literature-search-ingest) — Buscar e importar literatura faltante antes de ensamblar el paquete
- [Export/Import Literature Bundle](export-import-literature-bundle) — Exportar paquetes ZIP portables de elementos Zotero (propósito diferente)
