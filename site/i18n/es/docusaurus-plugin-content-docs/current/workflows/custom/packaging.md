...
- [Localización](localization) — Agregar soporte multiidioma a los workflows
- [Tipos de solicitudes](request-kinds) — Elegir el backend de ejecución y tipo de solicitud apropiados
- [Depuración y pruebas](debugging) — Verificar la correcta ejecución del workflow
