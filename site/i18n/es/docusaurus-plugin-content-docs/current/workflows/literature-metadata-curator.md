...
- [Literature Search & Ingest](literature-search-ingest) — Buscar nueva literatura e importar a Zotero
- [Literature Analysis](literature-analysis) — Generar resumen y análisis de citas desde PDF/Markdown
- [Tag Regulator](tag-regulator) — Normalizar etiquetas después de completar los metadatos
