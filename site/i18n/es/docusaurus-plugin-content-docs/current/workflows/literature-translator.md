...
Traducir un adjunto de literatura (Markdown o PDF) a un idioma de destino especificado, produciendo un archivo Markdown traducido y datos de alineación bilingüe. Se recomienda encarecidamente convertir primero los PDF a Markdown usando [MinerU](mineru) para una calidad de traducción significativamente mejor.
...
- [MinerU PDF Parsing](mineru) — Convertir PDF a Markdown primero para mejor calidad de traducción
- [Literature Analysis](literature-analysis) — Generar resumen de literatura y artefactos de análisis
