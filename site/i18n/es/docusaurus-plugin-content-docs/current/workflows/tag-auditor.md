...
- **Vocabulario controlado**: Un vocabulario de etiquetas controlado debe definirse primero; consulte [Gestión de etiquetas](../synthesis/tags)

## Flujos de trabajo relacionados

- [Tag Regulator](tag-regulator) — Normalizar etiquetas según el vocabulario controlado e inferir nuevas etiquetas
- [Tag Bootstrapper](tag-bootstrapper) — Crear interactivamente un vocabulario de etiquetas controlado
