...
Crear interactivamente un vocabulario de etiquetas controlado para un dominio de investigación con la IA. Se recomienda ejecutar antes del primer [Literature Analysis](literature-analysis) para establecer una base para la regulación automática de etiquetas posterior.
...
- [Literature Analysis](literature-analysis) — Puede ejecutar automáticamente la regulación de etiquetas en cascada durante el análisis
- [Tag Regulator](tag-regulator) — Ejecutar la regulación de etiquetas en la literatura existente
