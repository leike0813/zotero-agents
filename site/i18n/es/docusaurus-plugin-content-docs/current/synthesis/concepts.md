...
![Página de conceptos de Synthesis](/img/docs/synthesis/concepts.png)
...
Las propuestas de cambio a la base de conocimiento de conceptos (nuevos conceptos, nuevas acepciones, nuevas relaciones) aparecen en la pestaña de revisión Concepts del [Centro de revisión](review). Puedes revisar y decidir si aceptar estas propuestas.
...
- [Centro de revisión](review) — Revisar sugerencias de conceptos
- [Gestión de etiquetas](tags) — Gestionar el vocabulario controlado de etiquetas
- [Síntesis de temas](topic-synthesis) — Aprovechar el conocimiento de conceptos al crear síntesis de temas
