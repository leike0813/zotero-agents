...
![Vista Registry del Índice de Synthesis](/img/docs/synthesis/index.png)
...
En el [Centro de revisión](review), puedes ver y procesar las propuestas de coincidencia de citas, aceptándolas o rechazándolas una por una.
...
![Grafo de Citas de Synthesis](/img/docs/synthesis/citation-graph.png)
...
- [Centro de revisión](review) — Revisar propuestas de coincidencia de citas y deduplicación
- [Crear síntesis de temas](topic-synthesis) — Crear análisis temáticos basados en redes de citas
- [Panel Home](home) — Ver métricas de estadísticas de la biblioteca
- [WebDAV Sync](webdav-sync) — Sincronizar datos de vinculación de citas entre dispositivos
