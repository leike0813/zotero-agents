...
See the [Localization](localization) page for the complete localization mechanism.

## Next Steps

- [Selection Context](selection-context) — Understand how the user's item selection is passed to the workflow
- [Request Kinds](request-kinds) — Parameter passing methods for different request kinds
