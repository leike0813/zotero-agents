...
- **Controlled Vocabulary**: A controlled tag vocabulary must be defined first; see [Tags Management](../synthesis/tags)

## Related Workflows

- [Tag Regulator](tag-regulator) — Normalize tags based on the controlled vocabulary and infer new tags
- [Tag Bootstrapper](tag-bootstrapper) — Interactively create a controlled tag vocabulary
