...
Zotero Skills 扩展了 Zotero 的能力，使其能够运行 **Agent 技能**——这些基于 AI 的工作流可以处理文献、生成摘要、管理标签等。
...
- [GitHub 仓库](https://github.com/leike0813/Zotero-Skills)
- [问题追踪](https://github.com/leike0813/Zotero-Skills/issues)
