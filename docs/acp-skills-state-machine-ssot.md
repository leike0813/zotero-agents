...
(defined by `docs/skillrunner-sequence-recovery-state-machine.md`).
...
|---------|---------------|
| Run Status 定义 | `src/modules/acp/skillRun/acpSkillRunStore.ts` |
| Conversation State 定义 | `src/modules/acp/skillRun/acpSkillRunStore.ts` |
| Recovery State 定义 | `src/modules/acp/skillRun/acpSkillRunStore.ts` |
| Reply State 定义 | `src/modules/acp/skillRun/acpSkillRunStore.ts` |
| Connection Action State 定义 | `src/modules/acp/skillRun/acpSkillRunStore.ts` |
| Prompt Interruption State 定义与归一化 | `src/modules/acpTypes.ts` |
| Output Revision Status 定义 | `src/modules/acp/skillRun/acpSkillRunStore.ts` |
| Run record parsing and five run-axis normalizers | `src/modules/acp/skillRun/acpSkillRunPersistence.ts` |
| `isTerminalAcpSkillRunStatus` | `src/modules/acp/skillRun/acpSkillRunStore.ts` |
| Post-terminal eligibility and controller purpose | `src/modules/acp/skillRun/acpSkillRunStore.ts` |
| `AcpSkillRunRecord` 完整记录 | `src/modules/acp/skillRun/acpSkillRunStore.ts` |
| Setup/live controller registry, reply/connect/disconnect/cancel controls | `src/modules/acp/skillRun/acpSkillRunStore.ts` |
| Initial ACP lifecycle, interruption, deferred outcome | `src/modules/acp/skillRun/acpSkillRunnerOrchestrator.ts` |
| Session recovery and recovered controller lifecycle | `src/modules/acp/skillRun/acpSkillRunRecovery.ts` |
...
| ACP Skills owner/navigation/interaction projection | `src/modules/acp/skillRun/acpSkillsWorkspaceSurface.ts` |
| ACP Skills navigation task state | `src/modules/acp/skillRun/acpSkillRunTaskProjection.ts` |
| Shared Assistant task presentation projection | `src/sidebar/assistantPanelModel.js` |
| Owner-first publication runtime | `src/modules/assistant/publication/assistantWorkspacePublicationRuntime.ts` |
| ACP Skills transcript page/mirror lifecycle | `src/modules/acp/skillRun/acpSkillRunTranscriptMirror.ts` |
| `AcpConnectionAdapter` 连接生命周期 | `src/modules/acp/transport/acpConnectionAdapter.ts` |
