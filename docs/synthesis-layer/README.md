...
This directory is the canonical design anchor for the Synthesis Layer. Historical governance and engineering alternatives are archived under `artifacts/archive/`.
...
- Archive historical alternatives under `artifacts/archive/`; do not mix them into active design docs.
