...
配套文档：
- `docs/components/runtime-persistence-governance-ssot.md` — 运行时持久化治理
- `docs/components/skillrunner-provider-state-machine-ssot.md` — SkillRunner run settlement 状态机
- `docs/components/workflow-execution-seams.md` — 工作流执行 seam 与 deferred completion 边界
- `docs/components/literature-artifact-migration.md` — Literature Artifact 迁移运行时、私有 receipt 与 Dashboard 边界
