...
The Workflow Editor Host (`src/modules/workflow/ui/workflowEditorHost.ts`) is a generic
...
- **Workflow Debug Probe** (`src/modules/workflow/ui/workflowDebugProbe.ts`) — registers a
