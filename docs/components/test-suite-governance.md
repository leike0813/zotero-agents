...
- `tests/ui/35-workflow-settings-execution.test.ts` (smoke subset)
- `tests/ui/40-gui-preferences-menu-scan.test.ts` (host-shell subset)
- `tests/ui/50-workflow-settings-dialog-model.test.ts` (smoke subset)
...
- `tests/workflow-tag-regulator/64b-workflow-tag-regulator-apply-intake.test.ts` (host-safe subset)
...
- `tests/core/63-job-queue-progress.test.ts` (selected cases)
- `tests/core/70a-skillrunner-task-reconciler-state-restore.test.ts` (selected cases)
- `tests/core/70b-skillrunner-task-reconciler-apply-bundle-retry.test.ts` (selected cases)
- `tests/core/70c-skillrunner-task-reconciler-ledger-reconcile.test.ts` (selected cases)
...
- `tests/core/71-skillrunner-run-dialog-ui-e2e-alignment.test.ts` is covered by
...
- default output path is `artifacts/test-diagnostics/`
- capture at least:
  - `test-start`
  - `pre-cleanup`
