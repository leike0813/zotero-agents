...
The workflow settings dialog (`src/modules/workflow/settings/workflowSettingsDialog.ts` +
`src/modules/workflow/settings/workflowSettingsDialogModel.ts`) provides a form-based UI for
