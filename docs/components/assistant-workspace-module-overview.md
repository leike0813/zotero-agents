...
- `docs/components/assistant-workspace-acp-surface-ssot.md` owns the runtime
...
- `docs/components/assistant-sidebar-panel-ui-ssot.md` owns the visible UI/UX
...
package "Host plane (src/modules/)" {
  ...
  [assistant/workspace/assistantWorkspaceSidebar.ts\n(panel host, public facade)] as Sidebar
...
`src/modules/assistant/workspace/assistantWorkspaceSidebar.ts` is the only public facade of the
...
`src/modules/assistant/publication/assistantExecutionDisplayPolicy.ts` exports
