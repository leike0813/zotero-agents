...
The note payload codec (`src/modules/zoteroHost/notePayloadCodec.ts`) provides encoding and
...
Managed-note semantics belong to `src/modules/zoteroHost/zoteroManagedNotes.ts`, reached
