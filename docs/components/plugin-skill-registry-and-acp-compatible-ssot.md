...
- `references/Skill-Runner/server/services/orchestration/run_skill_materialization_service.py`
- `references/Skill-Runner/server/services/skill/skill_patcher.py`
- `references/Skill-Runner/docs/output_contract_prompt_injection_ssot.md`
- `references/Skill-Runner/server/assets/templates/run_execution_instructions.md.j2`
- `references/Skill-Runner/server/services/orchestration/run_bundle_service.py`
