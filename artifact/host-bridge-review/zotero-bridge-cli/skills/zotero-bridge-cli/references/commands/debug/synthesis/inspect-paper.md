...
- 输出边界： `limit`；受管详情： {"defaultLimit":25,"fileField":"data.delivery.bundle","maxLimit":100,"section":"data.repository.artifactSidecars","strategy":"limit","truncatedField":"data.truncated"}.
- Pagination: `none`.
- 类别： `debug`；危险等级： `none`.
