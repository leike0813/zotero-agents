...
- 输出边界： `limit`; governed details: {"strategy":"limit","section":"data.repository.artifactSidecars","defaultLimit":25,"maxLimit":100,"truncatedField":"data.truncated","fileField":"data.delivery.bundle"}.
- 分页： `none`.
