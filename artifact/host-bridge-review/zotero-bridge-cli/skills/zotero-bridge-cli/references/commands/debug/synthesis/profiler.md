...
- 输出边界： `limit`; governed details: {"strategy":"limit","section":"data.runs","defaultLimit":25,"maxLimit":100,"truncatedField":"data.truncated","fileField":"data.delivery.bundle"}.
- 分页： `none`.
