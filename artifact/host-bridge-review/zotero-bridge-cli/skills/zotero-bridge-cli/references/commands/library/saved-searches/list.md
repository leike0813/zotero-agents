...
| Token | Id | Kind | Required | Conditional requirement | Values / arity | Repeatable | Environment | Conflicts | Help |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| --library-id | library_id | 选项 | 否 | — | LIBRARY_ID | 否 | — | — | 文献库身份；默认使用用户文献库 |
...
- 输出边界：`cursor`；受治理的细节：{"continuation":["data.nextCursor","data.hasMore","data.returned","data.total","data.limit"],"cursorInput":"cursor","defaultLimit":25,"maxLimit":100,"section":"data.savedSearches","strategy":"cursor"}.
- 分页： `cursor`.
