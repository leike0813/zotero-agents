...
- 输出边界：`cursor`；受治理的细节：{"continuation":["data.nextCursor","data.hasMore","data.returned","data.total","data.limit"],"cursorInput":"cursor","defaultLimit":25,"maxLimit":100,"section":"data.notes","strategy":"cursor"}.
- 分页： `cursor`.
