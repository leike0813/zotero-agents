...
- 输出边界：`cursor`；受治理的细节：{"continuation":["data.nextCursor","data.hasMore","data.returned","data.total","data.limit","data.scanned"],"cursorInput":"cursor","defaultLimit":25,"maxLimit":100,"section":"data.payloads","strategy":"cursor"}.
- 分页： `cursor`.
