...
- 输出边界： `offset`；受管详情： {"continuation":["data.nextOffset","data.hasMore","data.totalChars","data.truncated","data.maxChars"],"cursorInput":"offset","defaultLimit":8000,"maxLimit":16000,"section":"data.text","strategy":"offset"}.
- 分页： `cursor`.
