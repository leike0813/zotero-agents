...
- 输出边界： `cursor`；受管详情： {"continuation":["data.pagination.papers.nextCursor","data.pagination.papers.hasMore","data.pagination.papers.returned","data.pagination.papers.total","data.pagination.papers.limit"],"cursorInput":"cursor","defaultLimit":25,"maxLimit":100,"section":"data.papers","strategy":"cursor"}.
- 分页： `cursor`.
- 类别： `read`；危险等级： `none`.
