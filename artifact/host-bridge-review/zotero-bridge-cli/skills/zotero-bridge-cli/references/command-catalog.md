...
| `zotero-bridge context selection get` | 读取选中 Zotero 条目的一个精确分页 | [Open card](commands/context/selection/get.md) |
...
| `zotero-bridge library items export-research-bundle` | 将一篇或多篇论文导出为研究包 | [打开卡片](commands/library/items/export-research-bundle.md) |
...
| `zotero-bridge library saved-searches list` | 从源头分页列出已保存的搜索 | [打开命令卡](commands/library/saved-searches/list.md) |
