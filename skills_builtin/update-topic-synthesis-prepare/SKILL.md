...
# Update Topic Synthesis Preparation
...
- Host read：`<zotero-bridge> synthesis index library get --query '{"cursor":0,"limit":100}'`。用途：读取 Synthesis sidecar cache 的文库索引，用于判断是否向当前 resolver proposal 增加文献条件。
