...
```console
zotero-bridge context selection get [--endpoint <ENDPOINT>] [--operation-id <ID>] [--profile <PATH>] [--schema]
```
...
- Operational aliases: `context selection get`, `context`, `selection`, `get`.
