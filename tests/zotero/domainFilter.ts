...
const CORE_PATH_RE = /(^|\/)tests\/core\//;
const UI_PATH_RE = /(^|\/)tests\/ui\//;
const WORKFLOW_PATH_RE = /(^|\/)tests\/workflow-/;
...
const ZOTERO_LITE_ALLOWLIST: Record<Exclude<TestDomain, "all">, RegExp[]> = {
  core: [
    ...
    /(^|\/)tests\/core\/102-acp-zotero-mcp-server\.integration\.test\.ts$/,
    /(^|\/)tests\/core\/182-host-bridge-socket\.integration\.test\.ts$/,
    /(^|\/)tests\/core\/104-acp-zotero-opencode\.integration\.test\.ts$/,
    /(^|\/)tests\/core\/165-runtime-platform-services\.zotero\.test\.ts$/,
    ...
    /(^|\/)tests\/core\/275-managed-note-transaction\.zotero\.test\.ts$/,
    /(^|\/)tests\/core\/188-zotero-navigation\.zotero\.test\.ts$/,
  ],
  ui: [
    ...
    /(^|\/)tests\/ui\/183-acp-runtime-replay-publication-zotero-runtime\.test\.ts$/,
    /(^|\/)tests\/ui\/184-acp-skills-composer-continuation\.zotero\.test\.ts$/,
  ],
  workflow: [
...
> = {
  core: [
    /(^|\/)tests\/core\/42-task-runtime\.test\.ts$/,
    /(^|\/)tests\/core\/55-workflow-apply-seam-risk-regression\.test\.ts$/,
    /(^|\/)tests\/core\/60-task-dashboard-history\.test\.ts$/,
    /(^|\/)tests\/core\/62-task-dashboard-snapshot\.test\.ts$/,
    /(^|\/)tests\/core\/63-job-queue-progress\.test\.ts$/,
    /(^|\/)tests\/core\/70a-skillrunner-task-reconciler-state-restore\.test\.ts$/,
    /(^|\/)tests\/core\/70b-skillrunner-task-reconciler-apply-bundle-retry\.test\.ts$/,
    /(^|\/)tests\/core\/70c-skillrunner-task-reconciler-ledger-reconcile\.test\.ts$/,
    /(^|\/)tests\/core\/83-skillrunner-run-dialog-waiting-auth-observer\.test\.ts$/,
  ],
  ui: [],
  workflow: [],
};
...
> = {
  core: [
    ...
    "canonical navigation in Zotero runtime ",
  ],
  ui: [
    ...
    "ACP Skills composer continuation through platform transport ",
  ],
  workflow: [
