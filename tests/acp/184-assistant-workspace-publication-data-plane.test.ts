...
import type { AssistantWorkspaceTranscriptRegion } from "../../src/modules/assistant/publication/assistantWorkspaceTranscriptPublication.js";
import { AssistantWorkspacePublicationCoordinator } from "../../src/modules/assistant/publication/assistantWorkspacePublicationCoordinator.js";
import {
...
} from "../../src/modules/assistant/publication/assistantWorkspacePublicationRuntime.js";
import { readAssistantWorkspaceServiceStatus } from "../../src/modules/assistant/workspace/assistantWorkspacePublicationHost.js";
import {
  upsertAcpSkillRun,
...
} from "../../src/modules/acp/skillRun/acpSkillRunStore.js";
import {
  ACP_SKILLS_WORKSPACE_ADAPTER,
  readAcpSkillRunWorkspaceRegions,
} from "../../src/modules/acp/skillRun/acpSkillsWorkspaceSurface.js";
import {
  ACP_CHAT_WORKSPACE_ADAPTER,
  readAcpChatWorkspaceRegions,
} from "../../src/modules/acp/chat/acpChatWorkspaceSurface.js";
import {
  getActiveAcpChatOwner,
  getAcpChatWorkspaceOwnerNavigation,
} from "../../src/modules/acp/chat/acpSessionManager.js";
...
import { selectAcpSkillRun } from "../../src/modules/acp/skillRun/acpSkillRunWorkspaceSelection.js";
import { registerAcpSkillRunController } from "../../src/modules/acp/skillRun/acpSkillRunControllerRegistry.js";
...
describe("Assistant Workspace ACP publication data plane v1", function () {
  ...
  beforeEach(async function () {
    // Reset sequence mirrors tests/skillrunner/107 beforeEach; the acp-chat side is
