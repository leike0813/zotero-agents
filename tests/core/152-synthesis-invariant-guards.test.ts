...
import { inspectSynthesisServiceBoundary } from "../../scripts/synthesis/check-synthesis-service-boundary";
...
const CONTRACT_PATH = "docs/synthesis-layer/contracts/invariants.yaml";
