...
} from "../../src/modules/synthesis/sidecar/synthesisSidecarRuntimeInstaller";
import {
...
} from "../../scripts/synthesis/synthesis-sidecar-runtime-release-governance";
import { checkSynthesisSidecarRuntimeFreshness } from "../../scripts/synthesis/check-synthesis-sidecar-runtime-freshness";
import {
  stageSynthesisSidecarRuntimePrebuildArchives,
  stageSynthesisSidecarRuntimePrebuildSet,
} from "../../scripts/synthesis/stage-synthesis-sidecar-runtime-prebuilds";
import { syncSynthesisSidecarRuntimePrebuilds } from "../../scripts/synthesis/sync-synthesis-sidecar-runtime-prebuilds";
import {
...
} from "../../scripts/synthesis/synthesis-sidecar-runtime-release-controller";
import { loopbackRequest } from "../../scripts/synthesis/smoke-synthesis-rust-durable-candidate";
import { selectTrustedSynthesisSidecarVerification } from "../../scripts/synthesis/resolve-synthesis-sidecar-verification";
import {
  resolveSynthesisSidecarRuntimeCache,
  runSynthesisSidecarRuntimeCacheCommand,
} from "../../scripts/synthesis/resolve-synthesis-sidecar-runtime-cache";
import {
  packageSynthesisSidecarRuntimeSymbols,
  rebuildSynthesisSidecarRuntimeSymbolManifest,
} from "../../scripts/synthesis/package-synthesis-sidecar-runtime-symbols";
import { publishImmutableSynthesisSidecarRuntimeSet } from "../../scripts/synthesis/publish-synthesis-sidecar-runtime-prebuild";
import { extractSynthesisSidecarRuntimeArchive } from "../../scripts/synthesis/download-synthesis-sidecar-runtime-cache";
...
describe("Synthesis sidecar native runtime packaging", function () {
  ...
  it("separates runtime, bundle, verification, and pipeline identities", async function () {
    ...
    assert.include(inputs.build, "rust/synthesis-sidecar/build-recipe.json");
    assert.notInclude(
      inputs.source,
