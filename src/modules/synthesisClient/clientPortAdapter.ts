...
function requireClientPort<T>(port: T | undefined, operation: string): T {
...
function normalizeClientJson(value: unknown) {
...
function normalizeClientObject(value: unknown) {
  return toSynthesisJsonObject(normalizeClientJson(value), "$.response");
}

function normalizeClientResultObject(value: unknown, label: string) {
  const result = normalizeClientJson(value);
...
async function runClientPort<T>(operation: () => Promise<T>): Promise<T> {
  try {
...
function runClientJsonPort<Request, Result>(
  port:
    | ((
        request: Request,
  ...
  return runClientPort(async () => {
    ...
    const invoke = requireClientPort(port, operation);
    ...
    return rebuildResult
      ...
      : (normalizeClientResultObject(result, operation) as unknown as Result);
  });
}
...
function createSyncTransportClient(
  ...
  >(
    ...
    runClientPort(
      async () =>
        normalizeClientResultObject(
          await requireClientPort(port, operation)(),
  ...
  return {
    ...
    resolveConflict(request) {
      return runClientPort(async () => {
        ...
        const invoke = requireClientPort(
          ports.resolveConflict,
          `${operationPrefix}.resolveConflict`,
        );
        return normalizeClientResultObject(
          await invoke(normalizedRequest),
          "Synthesis Sync command",
      ...
      return rebuildSynthesisWorkbenchSurfaceResult(
        ...
        normalizeClientObject(
          await requireClientPort(
            port.getSynthesisWorkbenchSurfaceInput,
  ...
  return {
    ...
    graph: {
      ...
      async queryCluster(request = {}) {
        return runClientJsonPort(
          port.queryCitationGraphCluster,
          "graph.queryCluster",
          request,
      ...
      async refreshMetricsNow(request = {}) {
        return runClientJsonPort(
          port.refreshCitationGraphMetricsNow,
          "graph.refreshMetricsNow",
          request,
        ) as Promise<SynthesisPublicMaintenanceOperation>;
      },
      async recomputeCitationGraphLayout(request) {
        return runClientPort(
          async () =>
            normalizeClientObject(
              await requireClientPort(
                port.recomputeCitationGraphLayout,
      ...
      async rebuildCitationGraphCacheNow() {
        return runClientPort(
          async () =>
            normalizeClientObject(
              await requireClientPort(
                port.rebuildCitationGraphCacheNow,
      ...
      async refreshCitationGraphCacheIncrementalNow() {
        return runClientPort(
          async () =>
            normalizeClientObject(
              await requireClientPort(
                port.refreshCitationGraphCacheIncrementalNow,
      ...
      async retryCitationGraphCacheRebuild() {
        return runClientPort(
          async () =>
            normalizeClientObject(
              await requireClientPort(
                port.retryCitationGraphCacheRebuild,
    ...
    sync: {
      webDav: createSyncTransportClient(
        {
          runNow: port.syncWebDavNow,
          pause: port.pauseWebDavSync,
          resume: port.resumeWebDavSync,
          retry: port.retryWebDavSync,
          resolveConflict: port.resolveWebDavSyncConflict,
        },
        "sync.webDav",
      ),
    },
    topicGraph: {
      ...
      async applyTopicGraphReviewAction(request) {
        return runClientPort(async () => {
          ...
          const invoke = requireClientPort(
            port.applyTopicGraphReviewAction,
    ...
    references: {
      async startRefresh(request = {}) {
        return runClientJsonPort(
          port.startReferenceSidecarRefresh,
      ...
      async refreshReferenceSidecarNow() {
        return runClientPort(async () =>
          rebuildSynthesisReferenceCapabilityResult(
            ...
            await requireClientPort(
              port.refreshReferenceSidecarNow,
      ...
      async retryReferenceSidecarRefresh() {
        return runClientPort(async () =>
          rebuildSynthesisReferenceCapabilityResult(
            ...
            await requireClientPort(
              port.retryReferenceSidecarRefresh,
      ...
      async runAdvancedReferenceMatchingNow() {
        return runClientPort(async () =>
          rebuildSynthesisReferenceCapabilityResult(
            ...
            await requireClientPort(
              port.runAdvancedReferenceMatchingNow,
      ...
      async retryAdvancedReferenceMatching() {
        return runClientPort(async () =>
          rebuildSynthesisReferenceCapabilityResult(
            ...
            await requireClientPort(
              port.retryAdvancedReferenceMatching,
      ...
      async applyCanonicalRevisionReviewAction(request) {
        return runClientPort(async () => {
          ...
          const invoke = requireClientPort(
            port.applyCanonicalRevisionReviewAction,
      ...
      async applyReferenceMatchProposalAction(request) {
        return runClientPort(async () => {
          ...
          const invoke = requireClientPort(
            port.applyReferenceMatchProposalAction,
      ...
      async applyReferenceMatchProposalActions(request) {
        return runClientPort(async () => {
          ...
          const invoke = requireClientPort(
            port.applyReferenceMatchProposalActions,
      ...
      async mergeEffectiveCanonicalReference(request) {
        return runClientPort(async () => {
          ...
          const invoke = requireClientPort(
            port.mergeEffectiveCanonicalReference,
      ...
      async applyCanonicalRevisionMergeRequests(request) {
        return runClientPort(async () => {
          ...
          const invoke = requireClientPort(
            port.applyCanonicalRevisionMergeRequests,
      ...
      async updateCanonicalReferenceMetadata(request) {
        return runClientPort(async () => {
          ...
          const invoke = requireClientPort(
            port.updateCanonicalReferenceMetadata,
      ...
      async archiveCanonicalReference(request) {
        return runClientPort(async () => {
          ...
          const invoke = requireClientPort(
            port.archiveCanonicalReference,
    ...
    topics: {
      ...
      async purgeDeletedTopicArtifacts() {
        return runClientPort(
          async () =>
            normalizeClientObject(
              await requireClientPort(
                port.purgeDeletedTopicArtifacts,
      ...
      async restoreTopicDiscoveryHint(request) {
        return runClientPort(async () => {
          const normalizedRequest = normalizeTopicDiscoveryHintRequest(request);
          const invoke = requireClientPort(
            port.restoreTopicDiscoveryHint,
    ...
    system: {
      async reconcileRuntimeWorkOnStartup() {
        try {
          if (!port.reconcileSynthesisRuntimeWorkStateOnStartup) {
            throw new SynthesisClientError(
              "unavailable",
              "Synthesis startup reconciliation is unavailable",
            );
          }
          return port.reconcileSynthesisRuntimeWorkStateOnStartup();
        } catch (error) {
          throw normalizeClientError(error);
        }
      },
    ...
    maintenance: {
      async getOperation(request) {
        return runClientJsonPort(
          port.getPublicMaintenanceOperation,
      ...
      async controlOperation(
        ...
        return runClientJsonPort(
          port.controlPublicMaintenanceOperation,
      ...
      async resetDatabase(request) {
        try {
          if (!port.resetSynthesisDatabase) {
            throw new SynthesisClientError(
              "unavailable",
              "Synthesis database reset is unavailable",
            );
          }
          return await port.resetSynthesisDatabase(request);
        } catch (error) {
          throw normalizeClientError(error);
        }
      },
    ...
    notifications: {
      async consumeRelatedItemsSyncEcho(request) {
        try {
          if (!port.consumeRelatedItemsSyncEcho) {
            throw new SynthesisClientError(
              "unavailable",
          ...
          return {
            consumed: Boolean(await port.consumeRelatedItemsSyncEcho(request)),
          };
        } catch (error) {
          throw normalizeClientError(error);
        }
      ...
      async applyTopicSynthesisResult(request: SynthesisTopicApplyRequest) {
        return runClientPort(async () => {
          ...
          const result = await requireClientPort(
            port.applyTopicSynthesisResult,
    ...
    artifacts: {
      ...
      async exportFiltered(request, delivery) {
        return runClientJsonPort(
          port.exportFilteredPaperArtifacts,
    ...
    tags: {
      async initializeBuiltinTagPolicy() {
        return runClientPort(async () =>
          rebuildSynthesisTagCapabilityResult(
            ...
            await requireClientPort(
              port.initializeBuiltinTagPolicy,
      ...
      async isBuiltinTagPolicyInitialized() {
        return runClientPort(async () => {
          const initialized = await requireClientPort(
            port.isBuiltinTagPolicyInitialized,
      ...
      async rebuildTagVocabularyIndex() {
        return runClientPort(async () => {
          return rebuildSynthesisTagCapabilityResult(
            ...
            await requireClientPort(
              port.rebuildTagVocabularyIndex,
      ...
      async promoteStagedTagSuggestions(request) {
        return runClientPort(async () => {
          ...
          const invoke = requireClientPort(
            port.promoteStagedTagSuggestions,
      ...
      async discardStagedTagSuggestions(request) {
        return runClientPort(async () => {
          const normalized = normalizeTagSelectionRequest(request);
          const invoke = requireClientPort(
            port.discardStagedTagSuggestions,
      ...
      async clearStagedTagSuggestions() {
        return runClientPort(async () =>
          rebuildSynthesisTagCapabilityResult(
            ...
            await requireClientPort(
              port.clearStagedTagSuggestions,
      ...
      async previewTagVocabularyImport(request) {
        return runClientPort(async () => {
          ...
          const invoke = requireClientPort(
            port.previewTagVocabularyImport,
    ...
    debug: {
      ...
      async listOperations(request = {}) {
        return runClientJsonPort(
          port.debugSynthesisOperationsList,
      ...
      async listProfiler(request = {}) {
        return runClientJsonPort(
          port.debugSynthesisProfilerList,
          "debug.listProfiler",
          request,
          undefined,
          (value) =>
      ...
      async inspectPaper(request) {
        return runClientJsonPort(
          port.debugSynthesisPaperInspect,
          "debug.inspectPaper",
          request,
          undefined,
          (value) =>
      ...
      async inspectTopic(request) {
        return runClientJsonPort(
          port.debugSynthesisTopicInspect,
          "debug.inspectTopic",
          request,
          undefined,
          (value) =>
      ...
      async cleanInstallReset(request = {}) {
        return runClientJsonPort(
          port.debugSynthesisCleanInstallReset,
      ...
      async readProgress() {
        return runClientPort(
          async () =>
            normalizeClientObject({
              maintenance: {
                backgroundJobs: await requireClientPort(
                  port.getSynthesisBackgroundJobRows,
      ...
      async readChrome(request) {
        return runClientPort(
          async () =>
            normalizeClientObject(
              await requireClientPort(
                port.getSynthesisWorkbenchChromeInput,
