...
} from "../surface/skillRunnerBackendToasts";
import {
...
let onBackendsChanged: () => void = () => undefined;
...
export function startSkillRunnerBackendReachabilityCoordinator(args?: {
  onBackendsChanged?: () => void;
}) {
  if (args?.onBackendsChanged) {
    onBackendsChanged = args.onBackendsChanged;
  }
