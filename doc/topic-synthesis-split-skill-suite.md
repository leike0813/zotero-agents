...
Prepare step 创建 run workspace。Core 与 finalize 使用 `workspace: "reuse-workflow"`。Sequence result 使用 `final_step_id: "finalize"`，最终 Host apply 读取 finalize step 的 final candidate。
