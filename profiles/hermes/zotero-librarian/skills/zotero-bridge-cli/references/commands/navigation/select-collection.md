# `zotero-bridge navigation select-collection`
...
```json
{
  ...
  "binding": "passthrough",
  "category": "navigation",
  "command": "navigation select-collection",
  "composition": null,
  "danger": "none",
  "effects": [
    {
      "description": "Selects a collection.",
      "kind": "ui-navigation",
      "stateChanged": true
    }
  ],
  ...
  "targets": [
    {
      "kind": "capability",
      "target": "navigation.select_collection"
    }
  ]
}
```
