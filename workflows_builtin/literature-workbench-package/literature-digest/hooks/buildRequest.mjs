...
function resolveAttachmentPath(entry, runtime) {
  ...
  if (!path) {
    throw new Error("literature-digest buildRequest cannot resolve source attachment path");
  }
  return path;
}
...
function resolveSourceAttachmentPath(selectionContext, runtime) {
  ...
  if (attachments.length === 0) {
    throw new Error("literature-digest buildRequest requires one source attachment");
  }
...
export const __literatureDigestBuildRequestTestOnly = {
