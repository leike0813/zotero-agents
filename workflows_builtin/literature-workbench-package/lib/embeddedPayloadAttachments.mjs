...
export function workbenchPayloadArtifactName(payloadType) {
  return WORKBENCH_PAYLOAD_ARTIFACT_NAMES.get(normalizeText(payloadType)) || "";
}

export function workbenchPayloadText(block) {
  if (block?.format === "markdown") {
    return String(block.markdown || block.payload?.content || "");
  }
