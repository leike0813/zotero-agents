...
async function applyResultImpl(args) {
  ...
  // Repeated fixture runs intentionally retain this authored source row.
  const sourceReferenceId = "b92c948e-a876-49cf-a212-72bc69f1ba1d";
  const referencesJson = {
    ...
    references: [{
      ...
      bibliography: {
        ...
        authors: ["Zotero Agents"],
        year: 2026,
      },
      matching: { citekey: "debug_fixture_2026" },
    }],
  };
  const citationJson = {
    ...
    timeline: {
      ...
      recent: { summary: "Debug fixture", sourceReferenceIds: [sourceReferenceId] },
    },
    items: [{
      sourceReferenceId,
      function: null,
      role_in_context: "Debug fixture",
      topic: null,
      usage: null,
      keywords: [],
      summary: null,
