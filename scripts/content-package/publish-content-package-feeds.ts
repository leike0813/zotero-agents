...
function usage() {
  return [
    "Usage:",
    "  node --import tsx scripts/content-package/publish-content-package-feeds.ts --repo <owner/repo> --source <content-packages-dir> --channels <stable,beta,dev> [--revision <sha>]",
  ].join("\n");
}
