...
.EXAMPLE
    .\scripts\content-package\publish-skills.ps1              # publish all 4 default skills
    .\scripts\content-package\publish-skills.ps1 -DryRun      # preview what would happen
    .\scripts\content-package\publish-skills.ps1 -Push        # publish and push to remote
    .\scripts\content-package\publish-skills.ps1 -Skills create-topic-synthesis  # publish a single skill
#>
[CmdletBinding()]
param(
    [string[]]$Skills,
