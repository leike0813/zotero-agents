...
function help() {
  process.stdout.write(
    "Usage: tsx scripts/synthesis/publish-synthesis-sidecar-runtime-prebuild.ts --repo=<owner/name> --source-sha=<sha> --request-id=<id> --run-id=<id> --source-fingerprint=<sha256> --build-fingerprint=<sha256> --prebuild-pipeline-revision=<sha256> --archive-root=<path> --evidence-root=<path> --symbol-root=<path> --output=<path> [--remote-url=<url>]\n",
  );
}
