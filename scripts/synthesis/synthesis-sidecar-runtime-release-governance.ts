...
const SYNTHESIS_RUST_SIDECAR_ROOT = "rust/synthesis-sidecar";
const SOURCE_STATIC_INPUTS = [
  "rust/synthesis-sidecar/Cargo.toml",
  "rust/synthesis-sidecar/Cargo.lock",
  "rust/synthesis-sidecar/rust-toolchain.toml",
...
const BUILD_STATIC_INPUTS = [
  ...
  "rust/synthesis-sidecar/licenses.json",
  "package.json",
  "package-lock.json",
...
const PREBUILD_PIPELINE_STATIC_INPUTS = [
  ...
  "contracts/synthesis-sidecar/schemas/synthesis-sidecar-runtime-symbol-manifest.v1.schema.json",
