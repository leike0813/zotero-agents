...
function help() {
  process.stdout.write(
    "Usage: tsx scripts/synthesis/resolve-synthesis-sidecar-verification.ts --repo=<owner/name> --source-sha=<sha> --source-fingerprint=<sha256> --build-fingerprint=<sha256> --verification-fingerprint=<sha256> --verification-pipeline-revision=<sha256> --output=<path>\n       tsx scripts/synthesis/resolve-synthesis-sidecar-verification.ts --repo=<owner/name> --receipt=<path>\n",
  );
}
