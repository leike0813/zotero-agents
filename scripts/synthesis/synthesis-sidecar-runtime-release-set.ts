...
export const SYNTHESIS_SIDECAR_RUNTIME_RELEASE_SET_PATH =
  "releases/synthesis-sidecar/release-set.json";
export const SYNTHESIS_SIDECAR_RUNTIME_RELEASE_RECEIPT_PATH =
  "releases/synthesis-sidecar/latest-complete-release-receipt.json";
...
function help() {
  process.stdout.write(
    "Usage: tsx scripts/synthesis/synthesis-sidecar-runtime-release-set.ts --source-commit=<sha> --prebuild-result=<path> --verification-result=<path> [--output=<path>]\n",
  );
}
