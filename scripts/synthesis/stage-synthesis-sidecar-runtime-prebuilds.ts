...
async function main() {
  if (process.argv.includes("--help")) {
    process.stdout.write(
      "Usage: tsx scripts/synthesis/stage-synthesis-sidecar-runtime-prebuilds.ts (--input-root=<path> | --archive-root=<path>) --output-root=<path> --build-fingerprint=<sha256> [--source-fingerprint=<sha256>]\n",
    );
    return;
  }
