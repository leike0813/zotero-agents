  ...
  const checks: Array<[string, string[]]> = [
    ...
    [
      ...
      [
        ...
        "tests/host-bridge/108-host-bridge-workflow-control.test.ts",
        "tests/host-bridge/139-host-bridge-cli-packaging.test.ts",
        "tests/host-bridge/165-zotero-librarian-profile.test.ts",
        "tests/host-bridge/167-host-bridge-semantic-review-skill.test.ts",
        "tests/host-bridge/168-host-bridge-release-coordinator.test.ts",
        "tests/host-bridge/169-host-bridge-agent-surface.test.ts",
        "--require",
        "tests/setup/zotero-mock.ts",
      ],
    ],
  ];
  if (!prebuildRequired) {
