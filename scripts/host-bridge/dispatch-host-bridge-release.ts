  ...
  const checks: Array<[string, string[]]> = [
    ...
    [
      ...
      [
        ...
        "tests/core/108-host-bridge-workflow-control.test.ts",
        "tests/core/139-host-bridge-cli-packaging.test.ts",
        "tests/core/165-zotero-librarian-profile.test.ts",
        "tests/core/167-host-bridge-semantic-review-skill.test.ts",
        "tests/core/168-host-bridge-release-coordinator.test.ts",
        "tests/core/169-host-bridge-agent-surface.test.ts",
        "--require",
