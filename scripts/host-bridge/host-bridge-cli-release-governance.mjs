...
export const RELEASE_MANIFEST_PATH = "releases/host-bridge/cli-release.json";
export const ADDON_RELEASE_MANIFEST_PATH =
  "addon/bin/zotero-bridge-release.json";
export const CARGO_TOML_PATH = "rust/zotero-bridge/Cargo.toml";
export const CARGO_LOCK_PATH = "rust/zotero-bridge/Cargo.lock";
export const BUILD_RECIPE_PATH = "rust/zotero-bridge/cli-build-recipe.json";
...
const BUILD_INPUT_PREFIXES = ["rust/zotero-bridge/src/"];
