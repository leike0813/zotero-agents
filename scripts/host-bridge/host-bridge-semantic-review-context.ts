...
function isGeneratedTarget(path: string) {
  return (
    path === "docs/host-bridge-cli.md" ||
    path === "releases/host-bridge/release-set.json" ||
    path.startsWith("artifacts/host-bridge-review/") ||
...
function isAgentControlContract(path: string) {
  return (
    path === "rust/zotero-bridge/src/surface.rs" ||
    path === "rust/zotero-bridge/src/contract.rs" ||
    path === "rust/zotero-bridge/src/error.rs" ||
    path === "scripts/host-bridge/host-bridge-agent-surface.ts" ||
    path === "contracts/host-bridge/capabilities.v2.json" ||
    path === "contracts/host-bridge/cli-commands.v2.json" ||
    path ===
...
function isReleaseContract(path: string) {
  return (
    path === "scripts/host-bridge/host-bridge-release-set.ts" ||
    path === "scripts/host-bridge/host-bridge-release-plan.ts" ||
    path === "contracts/host-bridge/surfaces.json" ||
    path === "scripts/host-bridge/host-bridge-surface-model.ts" ||
    path === "scripts/host-bridge/render-host-bridge-surfaces.ts" ||
    path === "scripts/host-bridge/check-host-bridge-skill-packages.ts" ||
    path === "scripts/host-bridge/host-bridge-review-mirror.ts" ||
    path === "scripts/host-bridge/render-host-bridge-release-set.ts" ||
    path === "scripts/host-bridge/materialize-host-bridge-surfaces.ts" ||
    path === "scripts/host-bridge/prepare-host-bridge-release.ts" ||
    path ===
      "contracts/host-bridge/schemas/host-bridge.release-set.v1.schema.json" ||
    path ===
      "contracts/host-bridge/schemas/host-bridge.release-receipt.v1.schema.json" ||
    path ===
      "contracts/host-bridge/schemas/host-bridge.release-set.v4.schema.json" ||
    path ===
...
function isSpecLayer(path: string) {
  return (
    ...
    path === "src/modules/hostBridge/server/hostBridgeServer.ts" ||
    path === "src/modules/hostBridge/server/hostBridgeProtocol.ts" ||
    path === "src/modules/hostBridge/workflow/hostBridgeWorkflowControl.ts" ||
    path === "src/modules/hostBridge/workflow/hostBridgeWorkflowAgentRun.ts" ||
    path ===
      "src/modules/hostBridge/permissions/hostBridgePermissionManager.ts" ||
    path === "src/modules/hostBridge/server/hostBridgeFileRegistry.ts" ||
    path ===
      "src/modules/hostBridge/permissions/hostBridgeWriteAutoApprovalRegistry.ts" ||
    path === "src/modules/workflow/ui/workflowExecute.ts" ||
    path.startsWith("src/modules/workflowExecution/") ||
    path === "rust/zotero-bridge/src/args.rs" ||
    path === "rust/zotero-bridge/src/commands.rs" ||
    path === "scripts/host-bridge/host-bridge-surface-catalog.ts" ||
    path === "contracts/host-bridge/surfaces.json" ||
    path === "scripts/host-bridge/host-bridge-surface-model.ts" ||
    path === "scripts/host-bridge/render-host-bridge-surfaces.ts" ||
    path === "scripts/host-bridge/check-host-bridge-skill-packages.ts" ||
...
function isSemanticReviewCandidate(path: string) {
  return (
    ...
    isSpecLayer(path) ||
    path.startsWith("contracts/host-bridge/schemas/host-bridge.") ||
